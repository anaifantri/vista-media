                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="bg-stone-400 h-10">
                                ...
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-28">Katagori</th>
                                                        ...
                                                        <form action="/marketing/clients/{{ $client->id }}" method="post"
                                                            ...
                                                            @if ($client->contacts()->exists())
                                                                <button
                                                                    ...
                                                                    onclick="return confirm('Apakah anda yakin ingin menghapus data klien dengan nama {{ $client->name }} sekaligus menghapus data-data yang berelasi?')">
