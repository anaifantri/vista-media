        ...
        <div class="flex justify-center w-full">
            <div class="w-[1200px]">
                <div class="flex border-b">
                    ...
                    <div class="flex">
                        <a href="/marketing/clients/create" class="flex index-link btn-primary">
                    ...
                    <thead>
                        <tr class="bg-teal-100 h-10">
                            ...
                            <th class="text-teal-700 border text-sm text-center w-24">
                                <button class="flex justify-center items-center w-24">@sortablelink('name', 'Klien')
                                    <svg class="fill-current w-3 ml-1" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z" />
                                    </svg>
                            ...
                            <th class="text-teal-700 border text-sm text-center w-44">
                                <button class="flex justify-center items-center w-44">@sortablelink('company', 'Nama Perusahaan')
                                    <svg class="fill-current w-3 ml-1" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z" />
                                    </svg>
                            ...
                            <th class="text-teal-700 border text-sm text-center w-24">Type</th>
                            <th class="text-teal-700 border text-sm text-center w-20">Katagori</th>
                            <th class="text-teal-700 border text-sm text-center w-24">No. Telepon</th>
                            <th class="text-teal-700 border text-sm text-center w-20">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($clients as $client)
                            <tr>
                                ...
                                <td class="text-teal-700 border text-sm text-center">{{ $client->code }}</td>
                                <td class="text-teal-700 border text-sm text-center">{{ $client->name }}</td>
                                ...
                                <td class="text-teal-700 border text-sm px-1">{{ $client->address }}</td>
                                <td class="text-teal-700 border text-sm text-center px-1">{{ $client->type }}</td>
                                <td class="text-teal-700 border text-sm text-center">
                                ...
                                <td class="text-teal-700 border text-sm text-center">
                                    <div class="flex justify-center items-center">
                                        ...
                                        <form action="/marketing/clients/{{ $client->id }}" method="post"
                                            class="d-inline my-1">
                                            @method('delete')
                                            @csrf
