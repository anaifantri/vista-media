...
@section('container')
    <div class="flex justify-center pl-14 py-10 bg-stone-800l">
                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="bg-stone-400 h-10">
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-8">No.</th>
                                ...
                                <th class="text-stone-900 border border-stone-900 text-sm text-center">Alamat</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-24">Type</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-20">Katagori</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-24">No. Telepon</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-20">Action</th>
                            </tr>
                        </thead>
