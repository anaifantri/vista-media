...
@section('container')
    ...
    @endphp
    <!-- Edit Location start -->
    <form class="flex" action="/locations/{{ $location->id }}" method="post" enctype="multipart/form-data">
        @method('put')
        @csrf
                            ...
                            <div class="flex w-[1140px] items-center border-b">
                                ...
                                <div class="flex items-center w-full justify-end">
                                    <button id="btnSave" name="btnSave"
                                        class="flex justify-center items-center ml-1 btn-primary" type="submit">
