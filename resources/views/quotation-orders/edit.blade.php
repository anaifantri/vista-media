...
@section('container')
    ...
    ?>
    <form method="post" action="/marketing/quotation-orders/{{ $quotation_order->id }}" enctype="multipart/form-data">
        @method('put')
        @csrf
                ...
                <div class="flex w-[950px] items-center border-b p-1">
                    ...
                    <div class="flex w-full justify-end">
                        ...
                        <a class="flex justify-center items-center mx-1 btn-danger"
                            href="/marketing/quotation-orders/show-orders/{{ $category }}/{{ $sale->id }}">
                ...
                <div class="grid grid-cols-2 gap-2 mt-2">
                    ...
                    <div class="border p-1 rounded-lg bg-stone-400">
                        <div class="flex w-full items-center text-sm border-b border-stone-900 m-1 font-semibold">
                            <label class="w-60">EDIT DATA PO</label>
                        </div>
                        <div class="flex w-full items-center text-sm m-1 mt-2">
                            <label class="w-36">Nomor PO</label>
                            <label>:</label>
                            <input class="outline-none ml-2 rounded-md border px-1" type="text" name="number"
                                placeholder="Input Nomor PO" value="{{ $quotation_order->number }}">
                        </div>
                        <div class="flex w-full items-center text-sm m-1">
                            <label class="w-36">Tanggal PO</label>
                            <label>:</label>
                            <input class="outline-none ml-2 rounded-md border px-1" type="date" name="date"
                                value="{{ $quotation_order->date }}">
                        </div>
                        <div class="flex w-full items-center text-sm m-1">
                            <label class="w-36">Ganti Dokumen</label>
                            <label>:</label>
                            <input type="text" name="oldImages" value="{{ $quotation_order->images }}" hidden>
                            <input id="documentOrders"
                                class="outline-none ml-2 rounded-md border px-1"name="document_order[]" type="file"
                                ...
                                @if ($loop->iteration == 1)
                                    <div class="divImage">
                                        <div class="flex w-full justify-center mt-2">
                                            <img class="w-[880px]" src="{{ asset('storage/' . $order) }}"
                                                alt="">
                                        </div>
                                    </div>
                                @else
