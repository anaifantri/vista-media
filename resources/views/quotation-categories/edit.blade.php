...
@section('container')
    <form method="post" action="/marketing/quotation-categories/{{ $quotation_category->id }}" enctype="multipart/form-data">
        @method('put')
        @csrf
            ...
            <div class="p-4 w-[350px] h-[500px] border rounded-lg">
                ...
                <div>
                    ...
                    <div class="flex justify-center mt-2 w-full">
                        <div class="w-[280px]">
                            ...
                            <input
                                ...
                                value="{{ $quotation_category->name }}" autofocus required>
                            @error('name')
                    ...
                    <div class="flex justify-center mt-2 w-full">
                        <div class="w-[280px]">
                            ...
                            <textarea
                                ...
                                name="description" placeholder="Input deskripsi bahan" rows="6">{{ $quotation_category->description }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="flex justify-center mt-4">
                        ...
                        <a href="/marketing/quotation-categories" class="flex items-center justify-center btn-danger mx-1">
