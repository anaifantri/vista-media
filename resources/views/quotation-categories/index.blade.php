            ...
            <div class="w-[1000px]">
                <div class="flex border-b">
                    ...
                    @canany(['isAdmin', 'isMedia'])
                        <div class="flex">
                            <a href="/quotation-categories/create" class="index-link btn-primary"><span></span>
                ...
                <form class="mt-2" action="/quotation-categories/">
                    <div class="flex">
                            ...
                            <tr>
                                ...
                                <td class="text-teal-700 border text-sm text-center">
                                    <div class="flex justify-center items-center">
                                        <a href="/quotation-categories/{{ $category->id }}"
                                        ...
                                        <a href="/quotation-categories/{{ $category->id }}/edit"
                                        ...
                                        @can('isAdmin')
                                            <form action="/quotation-categories/{{ $category->id }}" method="post"
                                                class="d-inline my-1">
                                                @method('delete')
                                                @csrf
                                                <button
