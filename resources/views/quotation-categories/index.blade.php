        ...
        <div class="flex justify-center w-full">
            <div class="w-[1000px]">
                <div class="flex border-b">
                    ...
                    <h1 class="index-h1"> DAFTAR KATAGORI PEMASARAN</h1>
                    <!-- Title Media Category end -->
                    <!-- Button Create New Media Category start -->
                    @canany(['isAdmin', 'isMedia'])
                        <div class="flex">
                            <a href="/marketing/quotation-categories/create" class="index-link btn-primary"><span></span>
                ...
                <form class="mt-2" action="/marketing/quotation-categories/">
                    <div class="flex">
        ...
        <div class="flex justify-center w-full">
            <div class="w-[1000px]">
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        @php
                            $number = 1 + ($quotation_categories->currentPage() - 1) * $quotation_categories->perPage();
                        @endphp
                        @foreach ($quotation_categories as $category)
                            <tr>
                                ...
                                <td class="text-teal-700 border text-sm text-center">
                                    <div class="flex justify-center items-center">
                                        <a href="/marketing/quotation-categories/{{ $category->id }}"
                                        ...
                                        <a href="/marketing/quotation-categories/{{ $category->id }}/edit"
                                        ...
                                        @can('isAdmin')
                                            <form action="/marketing/quotation-categories/{{ $category->id }}" method="post"
                                                class="d-inline my-1">
                                                @method('delete')
                                                @csrf
                                                <button
                                                    class="index-link text-white w-7 h-5 bg-red-500 rounded-md hover:bg-red-600"
                                                    onclick="return confirm('Apakah anda yakin ingin menghapus data katagori pemasaran dengan nama {{ $category->name }} ?')">
