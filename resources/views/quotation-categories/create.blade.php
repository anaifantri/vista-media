...
@section('container')
    <form method="post" action="/quotation-categories" enctype="multipart/form-data">
        @csrf
        <div class="flex justify-center mt-10">
            <div class="p-4 w-[350px] h-[500px] border rounded-lg">
                <div class="flex items-center justify-center mb-2 border-b w-full">
                    <h4 class="text-xl font-semibold tracking-wider text-teal-900">Tambah Katagori Pemasaran</h4>
                </div>
