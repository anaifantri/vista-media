        ...
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex justify-center w-full">
                <div class="w-[1200px]">
                    ...
                    <form id="formFilter" action="/income-taxes/index/{{ $company->id }}">
                        <div class="flex">
                            <div class="flex h-14">
                                <div class="w-24">
                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="bg-stone-400 h-8">
                                ...
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-72">
                                    Klien
                                </th>
                                ...
                                @if ($payment->income_taxes->sum('nominal') > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-stone-900 px-2 border border-stone-900 text-sm text-right">
                                            {{ number_format($payment->billings->sum('nominal')) }}
                                        </td>
                                        <td class="text-stone-900 px-2 border border-stone-900 text-sm text-right">
                                        ...
                                        <td class="text-stone-900 px-2 border border-stone-900 text-sm text-center">
                                            <div class="flex justify-center items-center">
                                                @if (!empty($payment->income_tax_document))
                                                    <a href="/accounting/income-tax-documents/{{ $payment->income_tax_document->id }}"
