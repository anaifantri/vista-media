...
<table class="table-auto mt-2 w-full">
    <thead>
        <tr class="h-10 bg-stone-300">
            <th class="text-sm text-black border">Lokasi
            </th>
            <th class="text-sm text-black border w-16">Jenis</th>
            <th class="text-sm text-black border w-28">Bahan</th>
            <th class="text-sm text-black border w-12">Side</th>
            <th class="text-sm text-black border w-12">Luas</th>
            <th class="text-sm text-black border w-14">Harga</th>
            <th class="text-sm text-black border w-20">Total</th>
        </tr>
    </thead>
    <tbody>
        @if ($printStatus == true && $installStatus == true)
            <tr>
                <td class="text-sm text-black border px-2" rowspan="{{ $rowSpan }}">
                    <div class="flex">
                    ...
                    <div class="flex">
                        <label class="w-12 font-semibold">Catatan</label>
                        <label class="ml-2 font-semibold">: </label>
                        <label class="ml-1 font-semibold">
                            {{ $serviceNote }}
                        </label>
                    </div>
                </td>
                <td class="text-sm text-black border px-1 text-center">Cetak</td>
                <td class="text-sm text-black border text-center">
                    {{ $pricePrint->printProduct }}
                </td>
                <td class="text-sm text-black border text-center px-1" rowspan="{{ $rowSpan }}">
                    {{ $side }}
                </td>
                <td class="text-sm text-black border text-center" rowspan="{{ $rowSpan }}">
                    {{ $wide }}
                </td>
                <td class="text-sm text-black border text-center px-1">
                    {{ number_format($getPricePrint) }}
                </td>
                <td class="text-sm text-black border text-right px-2">
                    {{ number_format($getPricePrint * $wide) }}
                </td>
            </tr>
            <tr>
                <td class="text-sm text-black border px-1 text-center">Pasang</td>
                <td class="text-sm text-black border text-center">
                    {{ $priceInstall->type }}
                </td>
                <td class="text-sm text-black border text-center px-1">
        ...
        <tr>
            ...
            <td id="priceValue" class="text-sm text-black border text-right font-semibold px-2">
                {{ number_format($getSubTotal) }}
            </td>
        </tr>
        <tr>
            <td class="text-sm text-black border text-right font-semibold px-2" colspan="6">PPN
            </td>
