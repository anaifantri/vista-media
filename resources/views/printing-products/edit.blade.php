...
@section('container')
    <form method="post" action="/printing-products/{{ $printing_product->id }}" enctype="multipart/form-data">
        @method('put')
        @csrf
            ...
            <div class="w-[350px] h-[500px] border rounded-lg p-4">
                ...
                <div>
                    ...
                    <div class="flex justify-center w-full mt-4">
                        ...
                        <a href="/printing-products" class="flex items-center justify-center btn-danger mx-1">
