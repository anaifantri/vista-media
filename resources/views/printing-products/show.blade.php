...
@section('container')
    ...
    @endphp
    <div class="flex justify-center w-full items-center p-10">
        <div class="w-[315px] border rounded-lg h-max px-4">
            <div class="flex items-center justify-center w-full border-b mt-2">
                <h4 class="text-2xl font-semibold tracking-wider text-teal-900">Detail Bahan Cetak</h4>
            </div>
            <div class="border-b mt-2">
                <label class="text-sm text-teal-700">Kode</label>
                <h6 class="text-base font-semibold text-teal-900">{{ $printing_product->code }}</h6>
            </div>
            ...
            @endif
            <div class="flex mt-2">
                <a href="/printing-products" class="flex items-center justify-center btn-primary mx-1">
                ...
                <form action="/printing-products/{{ $printing_product->id }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
