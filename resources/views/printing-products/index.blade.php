...
@section('container')
    <!-- Container Index Printing Products start -->
    <div class="mt-10 z-0">
        <div class="flex justify-center w-full">
            <div class="w-[1000px]">
                <div class="flex border-b">
                    <!-- Title Printing Products start -->
                    <h1 class="index-h1"> DAFTAR BAHAN CETAK</h1>
                    <!-- Title Printing Products end -->
                    <!-- Button Create New Printing Products start -->
                    @canany(['isAdmin', 'isMedia'])
                        <div class="flex">
                            <a href="/printing-products/create" class="index-link btn-primary"><span></span>
                ...
                <form class="mt-2" action="/printing-products/">
                    <div class="flex">
                    ...
                    <tbody>
                        ...
                        @foreach ($printing_products as $printing_product)
                            <tr>
                                ...
                                <td class="text-teal-700 border text-xs text-center">{{ $printing_product->code }}</td>
                                ...
                                <td class="text-teal-700 border text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="/printing-products/{{ $printing_product->id }}/edit"
                                        ...
                                        @can('isAdmin')
                                            <form action="/printing-products/{{ $printing_product->id }}" method="post"
                                                class="d-inline m-1">
                                                @method('delete')
                                                @csrf
                                                <button
