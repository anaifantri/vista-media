            ...
            <div class="flex w-full justify-center">
                <div class="flex w-[950px]">
                    <button class="flex justify-center items-center mx-1 btn-primary" title="Save"
                        onclick="return confirm('Apakah anda yakin data yang diinput sudah benar..?'), insertSalesData()">
                                        ...
                                        <div class="flex justify-center mt-5">
                                            <div class="sale-detail">
                                                ...
                                                <div class="div-sale">
                                                    ...
                                                    <label class="label-sale-02">:</label>
                                                    <label id="labelPo"
                                                        class="label-sale-02 w-32 @error('document_po') is-invalid @enderror">
                                                        0
                                                        dokumen</label>
                                                ...
                                                @if ($category != 'Service')
                                                    <div class="div-sale">
                                                        ...
                                                        <label id="labelAgreement"
                                                            class="label-sale-02 w-32 @error('document_agreement') is-invalid @enderror">
                                                            0
                                                            dokumen</label>
                                                    ...
                                                    <div class="div-sale justify-center w-[350px] border rounded-lg p-1">
                                                        <div class="flex justify-center w-[160px]">
                                                            <div>
                                                                <div class="flex justify-center">
                                                                    <label class="text-sm text-teal-700">Awal Kontrak
                                                                        :</label>
                                                                </div>
                                                                <input id="start"
                                                        ...
                                                        <div class="flex justify-center w-[160px]">
                                                            <div>
                                                                <div class="flex justify-center">
                                                                    <label class="text-sm text-teal-700">Akhir Kontrak
                                                                        :</label>
                                                                </div>
