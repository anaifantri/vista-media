...
@section('container')
    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            ...
            <div>
                <!-- Form search start -->
                <form action="/workshop/electricity-top-ups/create">
    ...
    <script>
        ...
        rbPowerAction = (sel) => {
            ...
            linkCreate.setAttribute('href', '/create-electricity-top-up/' + electricalId);
        }

        linkCreateAction = () => {
            if (electricalId == "") {
                alert("Silahkan pilih daya listrik yang akan diisi pulsa..!!");
            } else {
                linkCreate.submit();
            }
        }
