        ...
        <div class="flex justify-center pl-14 py-10 bg-stone-800">
            <div class="p-4 w-[1000px] border rounded-lg bg-stone-700">
                <div class="flex items-center justify-center border-b p-1">
                    <h4 class="text-xl font-semibold tracking-wider text-stone-100 w-[750px]">TAMBAH DATA PENGISIAN PULSA
                        LISTRIK</h4>
                        ...
                        <div>
                            <div>
                                ...
                                <input name="topup_date"
                                    ...
                                    value="{{ old('topup_date') }}" type="date" autofocus required>
                            </div>
                            @error('topup_date')
                            ...
                            <div class="mt-2">
                                ...
                                <input name="top_up_nominal"
                                    ...
                                    value="{{ old('top_up_nominal') }}" type="number" min="0"
                            ...
                            <div class="mt-2">
                                ...
                                <input id="kwh_qty" name="kwh_qty" onkeyup="countLastKwh()" step="any"
                                    ...
                                    value="{{ old('kwh_qty') }}" type="number" min="0" placeholder="Input Jml. Kwh"
                                    required>
                            </div>
                            @error('kwh_qty')
                                <div class="text-red-600 flex mx-2">
                        ...
                        <div>
                            <div class="flex justify-center items-center w-full mt-1">
                                <button id="btnChooseImages"
                                    ...
                                    <span class="ml-2 text-xs">Upload Foto Nota Pembelian</span>
                                </button>
                            </div>
