    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            ...
            <div class="w-[1000px] mt-2 p-2">
                <label class="lex text-stone-100 test-sm font-semibold mt-2">DATA PENGISIAN PULSA</label>
                        ...
                        @foreach ($top_ups as $top_up)
                            <tr>
                                <td class="text-stone-900 border border-stone-900 text-xs px-1 text-center">
                                    {{ $loop->iteration }}</td>
                                <td class="text-stone-900 border border-stone-900 text-xs px-1 text-center">
                                    {{ date('d', strtotime($top_up->topup_date)) }}
                                    {{ $bulan[(int) date('m', strtotime($top_up->topup_date))] }}
                                    {{ date('Y', strtotime($top_up->topup_date)) }}
                                </td>
                                <td class="text-stone-900 border border-stone-900 text-xs px-1 text-center">
                                    {{ number_format($top_up->top_up_nominal) }}</td>
                                <td class="text-stone-900 border border-stone-900 text-xs px-1 text-center">
                                    {{ $top_up->kwh_qty }}</td>
                                <td class="text-stone-900 border border-stone-900 text-xs px-1 text-center">
                                    {{ $top_up->remaining_kwh_qty }}
                                </td>
                                <td class="text-stone-900 border border-stone-900 text-xs px-1 text-center">
                                    {{ $top_up->last_kwh_qty }}</td>
