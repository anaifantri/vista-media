...
@section('container')
    ...
    @endphp
    <form method="post" action="/accounting/vat-tax-invoices/{{ $vat_tax_invoice->id }}" enctype="multipart/form-data">
        @method('put')
        @csrf
                            ...
                            <div class="p-2 mt-2 border rounded-lg">
                                ...
                                <div class="flex mt-1">
                                    ...
                                    <input name="tax_date" type="date"
                                        ...
                                        value="{{ $vat_tax_invoice->tax_date }}" required>
                                </div>
                            </div>
                            <div class="p-2 mt-2 border rounded-lg">
                                <div class="flex">
