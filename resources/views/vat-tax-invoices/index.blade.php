    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex justify-center w-full">
                <div class="w-[1200px]">
                    <div class="flex border-b">
                        <h1 class="index-h1">DAFTAR FAKTUR PPN</h1>
                        <div class="flex">
                            @canany(['isAdmin', 'isAccounting'])
                                @can('isCollect')
                                    @can('isAccountingCreate')
                                        <a href="/vat-tax-invoices/select-billing/{{ $company->id }}" class="index-link btn-primary">
                                            ...
                                            <span class="mx-1">Upload Faktur PPN</span>
                                        </a>
                                    @endcan
                                @endcan
                            @endcanany
                ...
                <div class="w-[1200px]">
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="bg-stone-400 h-8">
                                ...
                                <th class="text-stone-900 border border-stone-900 text-xs text-center w-48">
                                    <button class="flex justify-center items-center w-full">@sortablelink('number', 'No. Faktur')
                        ...
                        <tbody class="bg-stone-200">
                            @foreach ($vat_tax_invoices as $vat_tax)
                                @php
                                ...
                                <tr>
                                    ...
                                    <td class="text-stone-900 px-1 border border-stone-900 text-xs text-right">
                                        Rp. {{ number_format($vat_tax->nominal) }},-
                                    </td>
                                    <td class="text-stone-900 px-1 border border-stone-900 text-xs  text-center">
                                        {{ count(json_decode($vat_tax->images)) }} dokumen
                                    </td>
                                    <td class="text-stone-900 px-1 border border-stone-900 text-xs text-center">
                                            ...
                                            @can('isAdmin')
                                                <form action="#" method="post" class="d-inline m-1">
                                                    ...
                                                    <button
                                                        ...
                                                        onclick="return confirm('Apakah anda yakin ingin menghapus data penagihan dengan nomor ?')">
            ...
            <div class="flex justify-center text-stone-100 mt-2">
                {!! $vat_tax_invoices->appends(Request::query())->render('dashboard.layouts.pagination') !!}
            </div>
        </div>
    </div>
@endsection
