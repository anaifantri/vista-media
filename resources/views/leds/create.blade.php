            ...
            <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
                ...
                <div class="flex w-full justify-center">
                    <div class="flex items-center w-[1000px] border-b">
                        <h1 class="flex text-xl text-stone-100 font-bold tracking-wider w-[650px]">MENAMBAHKAN DATA LED </h1>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                ...
                                <input
                                    ...
                                    name="pixel_density" title="Terisi otomatis" value="{{ old('pixel_density') }}"
                                    readonly required>
                                @error('pixel_density')
                                    <div class="invalid-feedback ml-3 w-56">
                                        {{ $message }}
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                ...
                                <select id="vertical_angle" name="vertical_angle"
                                    ...
                                    type="text" value="{{ old('vertical_angle') }}">
                                    <option value="pilih">- pilih -</option>
                            ...
                            <div class="mt-2">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('module_width') }}" placeholder="0" required>
