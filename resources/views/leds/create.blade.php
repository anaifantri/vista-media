        ...
        <div class="mt-10">
            ...
            <div class="flex w-full justify-center">
                <div class="flex items-center w-[1000px] border-b">
                    <h1 class="flex text-xl text-cyan-800 font-bold tracking-wider w-[650px]">MENAMBAHKAN DATA LED </h1>
            ...
            <div class="flex w-full justify-center items-center">
                <div class="flex justify-center w-[300px] h-[500px] border rounded-lg m-2 p-2">
                    <div>
                        <div class="mt-2">
                            <label class="w-36 ml-3 label-base">Nama Vendor</label>
                            <select class="flex input-area w-56 @error('vendor_id') is-invalid @enderror" name="vendor_id"
                                id="vendor_id" value="{{ old('vendor_id') }}" required>
                        ...
                        <div class="mt-2">
                            ...
                            <input class="flex input-area w-56 @error('name') is-invalid @enderror" type="text"
                                id="name" name="name" value="{{ old('name') }}" placeholder="Input Nama Produk"
                                autofocus required>
                            @error('name')
                                <div class="invalid-feedback ml-3 w-56">
                                    {{ $message }}
                        ...
                        <div class="mt-2">
                            ...
                            <select id="pixel_config" name="pixel_config"
                                ...
                                value="{{ old('pixel_config') }}">
                                <option value="pilih">- pilih -</option>
                                @foreach ($pixel_config as $pixel)
                                    @if (old('pixel_config') == $pixel)
                        ...
                        <div class="mt-2">
                            ...
                            <select id="pixel_pitch" name="pixel_pitch"
                                ...
                                value="{{ old('pixel_pitch') }}" onchange="setPixelDensity(this)">
                                <option value="pilih">- pilih -</option>
                                @foreach ($pixels as $pitch)
                                    @if (old('pixel_pitch') == $pitch)
                        ...
                        <div class="mt-2">
                            ...
                            <input
                                ...
                                name="pixel_density" title="Terisi otomatis" value="{{ old('pixel_density') }}" readonly
                                required>
                            @error('pixel_density')
                                <div class="invalid-feedback ml-3 w-56">
                                    {{ $message }}
                ...
                <div class="flex justify-center w-[300px] h-[500px] border rounded-lg m-2 p-2">
                    <div>
                        <div class="mt-2">
                            ...
                            <input class="flex input-area in-out-spin-none w-56 @error('max_power') is-invalid @enderror"
                                type="number" min="0" id="max_power" name="max_power"
                                placeholder="Input Daya Maksimal" value="{{ old('max_power') }}" autofocus required>
                            @error('max_power')
                                <div class="invalid-feedback ml-3 w-56">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mt-2">
                            ...
                            <input
                                ...
                                placeholder="Input Daya Rata-Rata" value="{{ old('average_power') }}" required>
                            @error('average_power')
                                <div class="invalid-feedback ml-3 w-56">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mt-2">
                            ...
                            <select id="vertical_angle" name="vertical_angle"
                                class="flex input-area w-56 @error('vertical_angle') is-invalid @enderror" type="text"
                                value="{{ old('vertical_angle') }}">
                                <option value="pilih">- pilih -</option>
                                @foreach ($angles as $angle)
                                    @if (old('vertical_angle') == $angle)
                        ...
                        <div class="mt-2">
                            ...
                            <select id="horizontal_angle" name="horizontal_angle"
                                ...
                                type="text" value="{{ old('horizontal_angle') }}">
                                <option value="pilih">- pilih -</option>
                                @foreach ($angles as $angle)
                                    @if (old('horizontal_angle') == $angle)
                                        <option value="{{ $angle }}" selected>
                                            {{ $angle }}
                                        </option>
                                    @else
                        ...
                        <div class="mt-2">
                            ...
                            <input class="flex input-area w-56 in-out-spin-none @error('brightness') is-invalid @enderror"
                                type="number" name="brightness" min="0" value="{{ old('brightness') }}"
                        ...
                        <div class="mt-2">
                            ...
                            <select id="refresh_rate" name="refresh_rate"
                                class="flex input-area w-56 @error('refresh_rate') is-invalid @enderror" type="text"
                                value="{{ old('refresh_rate') }}">
                                <option value="pilih">- pilih -</option>
                                @foreach ($refreshRate as $refresh)
                                    @if (old('refresh_rate') == $refresh)
                    ...
                    <div>
                        <div class="mt-2">
                            ...
                            <select id="optimal_distance" name="optimal_distance"
                                ...
                                type="text" value="{{ old('optimal_distance') }}">
                                <option value="pilih">- pilih -</option>
                                @foreach ($distances as $distance)
                                    @if (old('optimal_distance') == $distance)
                        ...
                        <div class="mt-2">
                            ...
                            <select id="cabinet_material" name="cabinet_material"
                                ...
                                @foreach ($materials as $material)
                                    @if (old('cabinet_material') == $material)
                        ...
                        <div class="mt-2">
                            ...
                            <input
                                ...
                                placeholder="Input berat kabinet" value="{{ old('cabinet_weight') }}" required>
                        ...
                        <div class="mt-2">
                            ...
                            <div class="flex items-center">
                                ...
                                <input
                                    class="flex input-area in-out-spin-none w-12 @error('module_width') is-invalid @enderror"
                                    type="number" name="module_width" min="0" value="{{ old('module_width') }}"
                                    placeholder="0" required>
                                <label class="label-base ml-3">Height</label>
                                <input
                                    class="flex input-area in-out-spin-none w-12 @error('module_height') is-invalid @enderror"
                                    type="number" name="module_height" min="0"
                                    value="{{ old('module_height') }}" placeholder="0" required>
                            </div>
                        </div>
                        <div class="mt-2">
                            ...
                            <div class="flex items-center">
                                <label class="label-base ml-3">Width</label>
                                <input
                                    class="flex input-area in-out-spin-none w-12 @error('cabinet_width') is-invalid @enderror"
                                    type="number" name="cabinet_width" min="0"
                                    value="{{ old('cabinet_width') }}" placeholder="0" required>
                                <label class="label-base ml-3">Height</label>
                                <input
                                    class="flex input-area in-out-spin-none w-12 @error('cabinet_height') is-invalid @enderror"
                                    type="number" name="cabinet_height" min="0"
                                    value="{{ old('cabinet_height') }}" placeholder="0" required>
                            </div>
                        </div>
                        <div class="mt-2">
                            ...
                            <div class="flex items-center">
                                ...
                                <input
                                    class="flex input-area in-out-spin-none w-12 @error('front_protection') is-invalid @enderror"
                                    type="number" name="front_protection" min="0"
                                    value="{{ old('front_protection') }}" placeholder="0" required>
                                <label class="label-base ml-3">Back</label>
                                <input
                                    class="flex input-area in-out-spin-none w-12 @error('back_protection') is-invalid @enderror"
                                    type="number" name="back_protection" min="0"
                                    value="{{ old('back_protection') }}" placeholder="0" required>
                            </div>
                        </div>
                    </div>
                </div>
