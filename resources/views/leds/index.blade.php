                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr class="bg-teal-100">
                            ...
                            <th class="th-table" rowspan="2">Nama Vendor</th>
                            <th class="th-table w-24" rowspan="2">
                            ...
                            <th class="th-table" colspan="4">Kabinet</th>
                            <th class="th-table w-24" rowspan="2">Brigthness (ccd/m)</th>
                            <th class="th-table w-24" rowspan="2">Refresh Rate (Hz)</th>
                            <th class="th-table w-36" rowspan="2">Action</th>
                        </tr>
                        <tr class="bg-teal-100">
                            <th class="th-table w-20">W ( mm )</th>
                            <th class="th-table w-20">H ( mm )</th>
                            <th class="th-table w-20">Material</th>
                            <th class="th-table w-20">Berat (kg)</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
                        ...
                        @foreach ($leds as $led)
                            <tr>
                                ...
                                <td class="text-teal-700 border text-sm text-center">{{ $led->cabinet_width }}</td>
                                <td class="text-teal-700 border text-sm text-center">{{ $led->cabinet_height }}</td>
