...
@section('container')
    <form method="post" action="/leds/{{ $led->id }}" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="mt-10">
            <!-- Show Title start -->
            <div class="flex w-full justify-center">
                <div class="flex items-center w-[1000px] border-b">
                    <h1 class="flex text-xl text-cyan-800 font-bold tracking-wider w-[650px]">MERUBAH DATA LED </h1>
                    ...
                    <div>
                        <div class="mt-2">
                            ...
                            <select class="flex input-area w-56 @error('vendor_id') is-invalid @enderror" name="vendor_id"
                                id="vendor_id" value="{{ $led->vendor->id }}" required>
                        ...
                        <div class="mt-2">
                            ...
                            <input class="flex input-area w-56 @error('name') is-invalid @enderror" type="text"
                                id="name" name="name" value="{{ $led->name }}" placeholder="Input Nama Produk"
                                autofocus required>
                            @error('name')
                                <div class="invalid-feedback ml-3 w-56">
                                    {{ $message }}
                        ...
                        <div class="mt-2">
                            ...
                            <div class="flex items-center">
                                ...
                                <input
                                    ...
                                    type="number" name="module_width" min="0" value="{{ $led->module_width }}"
                                    placeholder="0" required>
