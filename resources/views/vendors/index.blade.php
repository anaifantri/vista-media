                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="bg-stone-400 h-10">
                                ...
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-16">Katagori</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-44">Email</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-32">No. Telepon</th>
