            ...
            <div class="flex justify-center w-[500px] h-[550px] m-1 border rounded-lg">
                <div class="p-2 w-full justify-center">
                    <div class="flex items-center w-full border-b">
                        <h4 class="text-2xl font-semibold tracking-wider text-teal-900">DATA VENDOR</h4>
                    </div>
                    <div class="mt-2 w-full">
                        <div class="border-b mt-1"><label class="text-sm text-teal-700">Nama Vendor</label>
                            ...
                            <form action="/marketing/vendors/{{ $vendor->id }}" method="post" class="d-inline">
                                ...
                                @if ($vendor->vendor_contacts()->exists() || $vendor->leds()->exists() || $vendor->printing_prices()->exists())
                                    <button class="flex items-center justify-center btn-danger mx-1"
                                        onclick="return confirm('Berelasi dengan data kontak vendor, data led dan data harga cetak, apakah anda yakin ingin menghapus data perusahaan {{ $vendor->name }} sekaligus menghapus data-data yang berelasi?')">
                                        <svg class="fill-current w-5" clip-rule="evenodd" fill-rule="evenodd"
                                            stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <div class="flex justify-center w-full mt-2">
                                        <div>
                                            <div class="flex mt-1 items-center">
                                                ...
                                                <label class="text-sm text-teal-700 w-[150px]">Nama Vendor</label>
                            ...
                            <div class="flex border-t">
                                ...
                                <div class="mt-2 w-52">
                                    ...
                                    <div class="flex mt-2">
                                        ...
                                        <form action="/vendor-contacts/{{ $contact->id }}" method="post"
                                            class="d-inline">
                                            @method('delete')
                                            @csrf
                                            <button class="flex items-center justify-center btn-danger mx-1"
