    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex justify-center w-full">
                <div class="w-[1200px]">
                    <div class="flex border-b">
                        <h1 class="index-h1">DAFTAR BAST</h1>
                        <div class="flex">
                            @canany(['isAdmin', 'isAccounting'])
                                @can('isCollect')
                                    @can('isAccountingCreate')
                                        <a href="/work-reports/create/Media/{{ $company->id }}" class="index-link btn-primary">
                                            ...
                                            <span class="mx-1">Membuat BAST Media</span>
                                        </a>
                                        <a href="/work-reports/create/Service/{{ $company->id }}" class="index-link btn-warning ml-4">
                                            ...
                                            <span class="mx-1">Membuat BAST Cetak/Pasang</span>
                                        </a>
                                    @endcan
                                @endcan
                            @endcanany
                    ...
                    <form id="formFilter" action="/work-reports/index/{{ $company->id }}">
                        <div class="flex">
                            <div class="flex h-14">
                                <div class="w-24">
                        ...
                        <thead>
                            <tr class="bg-stone-400">
                                ...
                                <th class="text-stone-900 border border-stone-900 text-xs text-center w-32">
                                    <button class="flex justify-center items-center w-full">@sortablelink('number', 'No. BAST')
                                ...
                                <th class="text-stone-900 border border-stone-900 text-xs text-center w-44">
                                    Klien
                                </th>
            ...
            <div class="flex justify-center text-stone-100 mt-2">
                {!! $work_reports->appends(Request::query())->render('dashboard.layouts.pagination') !!}
            </div>
        </div>
    </div>
