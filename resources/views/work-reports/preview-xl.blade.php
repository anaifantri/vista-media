            ...
            <div class="w-[780px]">
                ...
                <div class="font-sans mt-10 text-lg">
                    ...
                    @if ($content->agreement_number != '' && $content->agreement_number != '')
                        <label class="text-justify w-[800px]">Dengan ini diberitahukan bahwa order XL untuk Media Luar
                            Ruang di site {{ $content->location_address }} ("Site") sebagaimana dituangkan dalam PO#
                            {{ $content->po_number }}, secara fisik telah kami selesaikan berikut dokumen-dokumen yang
                            diperlukan, sebagaimana telah dipersyaratkan dalam perjanjian induk nomor
                            {{ $content->agreement_number }} yaitu dokumen : </label>
                    ...
                    @elseif($content->agreement_number == '' && $content->agreement_number != '')
                        <label class="text-justify w-[800px]">Dengan ini diberitahukan bahwa order XL untuk Media Luar
                            Ruang di site {{ $content->location_address }} ("Site") sebagaimana dituangkan dalam PO#
                            ............................, secara fisik telah kami selesaikan berikut dokumen-dokumen
                            yang diperlukan, sebagaimana telah dipersyaratkan dalam perjanjian induk nomor
                            {{ $content->agreement_number }} yaitu dokumen : </label>
                    @else
                        <label class="text-justify w-[800px]">Dengan ini diberitahukan bahwa order XL untuk Media Luar
                            Ruang di site {{ $content->location_address }} ("Site") sebagaimana dituangkan dalam PO#
                            ...................................., secara fisik telah kami selesaikan berikut
                            dokumen-dokumen yang diperlukan, sebagaimana telah dipersyaratkan dalam perjanjian induk
                            nomor ...................... yaitu dokumen : </label>
                    @endif
