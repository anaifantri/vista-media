                ...
                @if ($loop->iteration < 4)
                    <div class="flex justify-center items-center w-10 h-6 border border-black ml-5">
                        @if ($ggCategory == $product->category)
                            <input class="outline-none" type="radio" name="mediaType" checked>
                        ...
                        @elseif ($ggCategory == 'Neon Box' && $product->category == 'Signage')
                            <input class="outline-none" type="radio" name="mediaType" checked>
                        @else
                            <input class="outline-none" type="radio" name="mediaType">
                        @endif
                    </div>
            ...
            <div class="flex justify-center items-center w-10 h-6 border border-black ml-5">
                @if ($product->category != 'Videotron' || ($product->category == 'Signage' && $description->type != 'Videotron'))
                    @if ($description->lighting == 'Backlight')
                        <input class="outline-none" type="radio" name="mediaLighting" checked>
                    @else
                        <input class="outline-none" type="radio" name="mediaLighting">
                    @endif
                @else
                    <input class="outline-none" type="radio" name="mediaLighting">
                @endif
        ...
        <div class="flex text-md items-center ml-2 mt-2">
            <div class="flex justify-center items-center w-10 h-6 border border-black ml-5">
                @if ($product->orientation == 'Vertical')
                    <input class="outline-none" type="radio" name="mediaOrientation" checked>
                @else
                    <input class="outline-none" type="radio" name="mediaOrientation">
                @endif
            </div>
