        ...
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex justify-center w-full ">
                <div class="flex w-[900px] border-b">
                    <!-- Title Area start -->
                    <h1 class="index-h1 w-[500px]">DATA AREA {{ strtoupper($area->area) }}</h1>
                    <!-- Title Area end -->
                    <div class="flex w-full justify-end items-center">
                        <a class="flex justify-center items-center mx-1 btn-primary" href="/media/area">
                ...
                <div class="flex justify-center">
                    <div class="w-full sm:w-[300px]">
                        <div class="flex mx-5 mt-1">
                            <span class="w-48 text-stone-100">Kode Area</span>
                            <label class="w-full h-8 rounded-lg bg-gray-50 px-2 text-stone-900" for="code">
                                {{ $area->area_code }}</label>
                        </div>
                        <div class="flex mx-5 mt-1">
                            <span class="w-48 text-stone-100">Nama Area</span>
                            <input type="text" id="area" name="area" hidden value="{{ $area->id }}">
                            <label class="w-full h-8 rounded-lg bg-gray-50 px-2 text-stone-900"
                                for="area">{{ $area->area }}</label>
                        </div>
                        <div class="flex mx-5 mt-1">
                            <span class="w-48 text-stone-100">Latitude</span>
                            <label class="w-full h-8 rounded-lg bg-gray-50 px-2 text-stone-900" for="lat"
                                id="lat" name="lat">{{ $area->lat }}</label>
                        </div>
                        <div class="flex mx-5 mt-1">
                            <span class="w-48 text-stone-100">Longitude</span>
                            <label class="w-full h-8 rounded-lg bg-gray-50 px-2 text-stone-900" for="lng"
                                id="lng" name="lng">{{ $area->lng }}</label>
                        </div>
                        <div class="flex mx-5 mt-1">
                            <span class="w-48 text-stone-100">Zoom</span>
                            <label class="w-full h-8 rounded-lg bg-gray-50 px-2 text-stone-900" for="zoom"
