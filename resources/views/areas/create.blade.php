...
@section('container')
    ...
    <form action="/area" method="post" class="d-inline">
        @csrf
        <div class="mt-10">
            <div class="flex justify-center w-full ">
                <div class="flex w-[900px] border-b">
                    ...
                    <div class="flex w-full justify-end items-center">
                        ...
                        <a class="flex justify-center items-center mx-1 btn-danger" href="/area">
                            <svg class="fill-current w-5 mx-1" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24">
                                <path
            ...
            <div class="flex justify-center mt-4">
                <div class="w-[300px] px-2">
                    <div class="flex mx-1 mt-3 items-center">
                        <label class="w-24 label">Kode Area</label>
                        <input name="area_code" class="input-area in-out-spin-none w-[160px]" type="number" min="0"
                            value="{{ old('area_code') }}" placeholder="Kode Area" autofocus required>
                    </div>
                    @error('area_code')
                    ...
                    @enderror
                    <div class="flex mx-1 mt-3 items-center">
                        <label class="w-24 label">Nama Area</label>
                    ...
                    @enderror
                    <div class="flex mx-1 mt-3 items-center">
                        <label class="w-24 label">Latitude</label>
                    ...
                    <div class="flex
                        ...
                        <label class="w-24 label">Longitude</label>
                    ...
                    <div class="flex
                            mx-1 mt-3 items-center">
                        <label class="w-24 label">Zoom</label>
                        <input id="zoom" name="zoom" class="input-area w-[160px] in-out-spin-none" min="0"
                            max="16" type="number" placeholder="Zoom" onkeyup="setZoom(this)" required>
                    </div>
                    @error('zoom')
                        <div class="text-red-600 flex mx-1">
                            {{ $message }}
