    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="bg-stone-400 h-10">
                                <th class="th-table border-stone-900 w-8">No.</th>
                                <th class="th-table border-stone-900 w-16">
                                ...
                                <th class="th-table border-stone-900 w-36">
                                ...
                                <th class="th-table border-stone-900 w-24">Latitude</th>
                                <th class="th-table border-stone-900 w-24">Longitude</th>
                                <th class="th-table border-stone-900 w-16">Zoom</th>
                                <th class="th-table border-stone-900 w-24">Dibuat Oleh</th>
                                <th class="th-table border-stone-900 w-24">Action</th>
                            </tr>
                        </thead>
                        <tbody class="bg-stone-200">
                            ...
                            @foreach ($areas as $area)
                                <tr>
                                    ...
                                    <td class="td-table-center border-stone-900">{{ $area->area_code }}</td>
                                    <td class="td-table-center border-stone-900">{{ $area->area }}</td>
                                    <td class="td-table-center border-stone-900">{{ $area->lat }}</td>
                                    <td class="td-table-center border-stone-900">{{ $area->lng }}</td>
                                    <td class="td-table-center border-stone-900">{{ $area->zoom }}</td>
                                    <td class="td-table-center border-stone-900">{{ $area->user->name }}</td>
                                    <td class="td-table-center border-stone-900">
                                        <div class="flex justify-center items-center">
                                            ...
                                            @canany(['isAdmin', 'isMedia'])
                                                @can('isArea')
                                                    @can('isMediaDelete')
                                                        <form action="/media/area/{{ $area->id }}" method="post"
                                                            class="d-inline m-1">
                                                            @method('delete')
                                                            @csrf
                                                            <button
            ...
            <div class="flex justify-center text-stone-900">
                {{-- {{ $areas->links() }} --}}
                {!! $areas->appends(Request::query())->render('dashboard.layouts.pagination') !!}
            </div>
        </div>
        <!-- View Area end -->
    </div>
