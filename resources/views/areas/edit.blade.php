...
@section('container')
    ...
    <form action="/area/{{ $area->id }}" method="post" class="d-inline">
        @method('put')
        @csrf
        <div class="mt-10">
                ...
                <div class="w-[300px] px-2">
                    <div class="flex mx-1 mt-3 items-center">
                        ...
                        <input name="area_code" class="input-area in-out-spin-none w-[160px]" type="number" min="0"
                            value="{{ $area->area_code }}" autofocus required>
                    </div>
                    @error('area_code')
                    ...
                    <div class="flex
                        ...
                        <input id="zoom" name="zoom" class="input-area w-[160px] in-out-spin-none" min="0"
                            max="16" type="number" value="{{ $area->zoom }}" onkeyup="setZoom(this)" required>
                    </div>
                    @error('zoom')
                        <div class="text-red-600 flex mx-1">
                            {{ $message }}
