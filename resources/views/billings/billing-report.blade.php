...
@section('container')
    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            ...
            <div class="flex justify-center w-full">
                @include('billings.pdf-view')
            </div>
            <div class="flex justify-center w-full">
                @include('billings.excel-view')
            </div>
        </div>
    </div>
    @if (request('month'))
    ...
    @else
        <input id="saveName" type="text" value="LIST INVOICE - {{ $bulan_full[(int) date('m')] }} {{ date('Y') }}"
            hidden>
    @endif
