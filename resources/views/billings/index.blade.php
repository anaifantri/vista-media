    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
                                ...
                                <tr>
                                    ...
                                    <td class="text-stone-900 px-1 border border-stone-900 text-xs text-center">
                                        <div class="flex justify-center items-center">
                                            ...
                                            @endcanany
                                            @can('isAdmin')
                                                <form action="/accounting/billings/{{ $billing->id }}" method="post"
                                                    class="d-inline m-1">
                                                    @method('delete')
                                                    @csrf
                                                    <button
                                                        class="index-link text-white w-7 h-5 bg-red-500 rounded-md hover:bg-red-600"
                                                        onclick="return confirm('Apakah anda yakin ingin menghapus data penagihan dengan nomor {{ $billing->number }} ?')">
            ...
            <div class="flex justify-center text-stone-100 mt-2">
                {!! $billings->appends(Request::query())->render('dashboard.layouts.pagination') !!}
            </div>
        </div>
    </div>
