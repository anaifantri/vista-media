    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex p-1 w-full border-b">
                <!-- Title start -->
                <h1 class="index-h1">Daftar Penayangan Materi Videotron</h1>
                <!-- Title end -->
                <div class="flex items-center w-full justify-end">
                    @canany(['isAdmin', 'isWorkshop', 'isMedia', 'isAccounting', 'isMarketing'])
                        @can('isContent')
                            @can('isWorkshopCreate')
                                <a href="/workshop/publish-contents/create" title="Tambah Data Upload" class="index-link btn-primary mx-1">
            ...
            <div>
                <!-- Form search start -->
                <form action="/workshop/publish-contents/">
                    <div class="flex mt-1">
                        <div class="w-36">
                            ...
                            <tr>
                                ...
                                <td class="text-stone-900 border border-stone-900 text-sm text-center">
                                    <div class="flex justify-center items-center">
                                        <a href="/workshop/publish-contents/{{ $content->id }}"
                                        ...
                                        @canany(['isAdmin', 'isMedia', 'isMarketing', 'isWorkshop', 'isOwner',
                                            ...
                                            @can('isContent')
                                                @can('isWorkshopEdit')
                                                    <a href="/workshop/publish-contents/{{ $content->id }}/edit"
                                        ...
                                        @canany(['isAdmin', 'isMedia', 'isMarketing', 'isWorkshop', 'isOwner',
                                            ...
                                            @can('isContent')
                                                @can('isWorkshopDelete')
                                                    <form action="/workshop/publish-contents/{{ $content->id }}" method="post"
                                                        class="d-inline m-1">
                                                        @method('delete')
                                                        @csrf
                                                        <button
