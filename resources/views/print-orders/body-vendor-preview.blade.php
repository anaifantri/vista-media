                    ...
                    <div class="flex">
                        <div class="w-[240px] border rounded-md p-1">
                            ...
                            <div class="flex mt-1">
                                ...
                                <label class="flex text-sm text-black">:</label>
                                <label
                                    class="flex border rounded-sm px-1 w-[175px] text-sm text-black ml-1">{{ $print_order->theme }}</label>
                            </div>
                            <div class="flex mt-1">
                                <label class="flex text-sm text-black w-14">Ukuran</label>
                                <label class="flex text-sm text-black">:</label>
                                <label
                                    class="flex text-sm border rounded-sm px-1 w-[175px] text-black ml-1">{{ $product->location_size }}</label>
                            </div>
                        </div>
