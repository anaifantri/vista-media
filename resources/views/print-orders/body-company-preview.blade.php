            ...
            <div class="flex justify-center w-full mt-2">
                <div class="w-[500px] border p-2">
                    <div class="flex">
                        <div class="w-[240px] border rounded-md p-1">
                            <div class="flex mt-1">
                                ...
                                <label class="flex border rounded-sm px-1 w-[175px] text-sm text-teal-900 ml-1">
                            ...
                            <div class="flex mt-1">
                                ...
                                <label class="flex text-sm text-teal-900">:</label>
                                <label
                                    class="flex border rounded-sm px-1 w-[175px] text-sm text-teal-900 ml-1">{{ $product->location_size }}</label>
                            </div>
                            <div class="flex mt-1">
                    ...
                    <div class="flex mt-1">
                        ...
                        <label class="flex text-sm text-teal-900">:</label>
                        <label
                            class="flex border rounded-sm px-1 w-[350px] text-sm text-teal-900 ml-1">{{ $notes->finishing }}</label>
                    </div>
                    <div class="flex mt-1">
                        <label class="flex text-sm text-teal-900 w-28">Catatan</label>
                        <label class="flex text-sm text-teal-900">:</label>
                        <label
                            class="flex border rounded-sm h-16 w-[350px] ml-1 text-sm text-teal-900 px-1">{{ $notes->note }}</label>
                    </div>
                </div>
