            ...
            <div class="mt-10">
                <div class="flex w-[1100px] border-b">
                    ...
                    <div class="flex justify-end w-full">
                        ...
                        <a class="flex justify-center items-center ml-1 btn-danger" href="/marketing/print-orders">
                ...
                <form action="/print-orders/select-locations">
                        ...
                        @if (request('orderType'))
                            @if (request('orderType') == 'sales')
                                <input class="outline-none" name="orderType" type="radio" onclick="submit()"
                                    value="sales" checked>
                                <label class="text-sm text-teal-900 ml-2" for="sales">Cetak Berbayar</label>
                            @else
                                <input class="outline-none" name="orderType" type="radio" onclick="submit()"
                                    value="sales">
                                <label class="text-sm text-teal-900 ml-2" for="sales">Cetak Berbayar</label>
                            ...
                            @if (request('orderType') == 'free')
                                <input class="outline-none ml-4" name="orderType" type="radio" onclick="submit()"
                                    value="free" checked>
                                <label class="text-sm text-teal-900 ml-2" for="free">Free Cetak Klien</label>
                            @else
                                <input class="outline-none ml-4" name="orderType" type="radio" onclick="submit()"
                                    value="free">
                                <label class="text-sm text-teal-900 ml-2" for="free">Free Cetak Klien</label>
                            ...
                            @if (request('orderType') == 'locations')
                                ...
                                <label class="text-sm text-teal-900 ml-2" for="locations">Free Cetak Lain-Lain</label>
                            @else
                                <input class="outline-none  ml-4" name="orderType" type="radio" onclick="submit()"
                                    value="locations">
                                <label class="text-sm text-teal-900 ml-2" for="locations">Free Cetak Lain-Lain</label>
            ...
            <div class="w-[1100px] mt-4">
                @if (request('orderType'))
                    ...
                    @elseif (request('orderType') == 'sales')
                        {{-- @include('print-orders.sales-table') --}}
