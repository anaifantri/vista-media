        ...
        <div class="flex justify-end w-full">
            <div>
                <div class="flex mt-1">
                    ...
                    <label id="copyVendorCompany" class="flex text-xs ml-1 w-60"></label>
                </div>
                <div class="flex mt-1">
                    <label class="flex text-xs w-28">Alamat</label>
                    <label class="flex text-xs">:</label>
                    <textarea id="copyVendorAddress" class="flex text-xs ml-1 w-60 border rounded-sm outline-none p-1" rows="2"
                        readonly></textarea>
                </div>
                <div class="flex mt-1">
                    <label class="flex text-xs w-28">No. Telp</label>
                    <label class="flex text-xs">:</label>
                    <label id="copyVendorPhone" class="flex text-xs ml-1 w-60"></label>
                </div>
            </div>
        </div>
    </div>
