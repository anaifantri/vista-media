...
@section('container')
    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        ...
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            ...
            <div class="flex w-[600px] items-center border-b pb-1">
                <h1 class="flex text-xl text-stone-100 font-bold tracking-wider w-[550px]">DOKUMEN PERSETUJUAN</h1>
            ...
            <div class="flex justify-center w-[600px]">
                <div>
                    <div class="relative mt-4 w-[600px] border">
                        ...
                        @foreach ($quotation_approvals as $approval)
                            @if ($loop->iteration == 1)
                                <div class="divImage">
                                        ...
                                        <div class="flex items-center">
                                            <div class="w-64">
                                                <div class="flex">
                                                    ...
                                                    <label
                                                        class="text-sm text-yellow-400 ml-2 w-40">{{ date('d', strtotime($approval->created_at)) }}
                                                        {{ $bulan[(int) date('m', strtotime($approval->created_at))] }}
                                                        {{ date('Y', strtotime($approval->created_at)) }}</label>
                                                </div>
                                                <div class="flex">
                                            ...
                                            <div class="flex w-full px-1 justify-end items-center">
                                                <form action="/marketing/quotation-approvals/{{ $approval->id }}"
                                    ...
                                    <img class="w-[600px]" src="{{ asset('storage/' . $approval->image) }}"
                                        alt="">
                                </div>
                            @else
