                    ...
                    @if (request('orderType'))
                        @if (request('orderType') == 'sales')
                            <input class="outline-none" name="orderType" type="radio" onclick="submit()" value="sales"
                                checked>
                            <label class="text-sm text-stone-100 ml-2" for="sales">Pemasangan Berbayar</label>
                        @else
                            <input class="outline-none" name="orderType" type="radio" onclick="submit()" value="sales">
                            <label class="text-sm text-stone-100 ml-2" for="sales">Pemasangan Berbayar</label>
                        @endif
                        @if (request('orderType') == 'free')
                            <input class="outline-none ml-4" name="orderType" type="radio" onclick="submit()"
                                value="free" checked>
                            <label class="text-sm text-stone-100 ml-2" for="free">Free Pemasangan Klien</label>
                        @else
                            <input class="outline-none ml-4" name="orderType" type="radio" onclick="submit()"
                                value="free">
                            <label class="text-sm text-stone-100 ml-2" for="free">Free Pemasangan Klien</label>
                        ...
                        @if (request('orderType') == 'locations')
                            ...
                            <label class="text-sm text-stone-100 ml-2" for="locations">Free Pemasangan Lain-Lain</label>
                        @else
                            <input class="outline-none  ml-4" name="orderType" type="radio" onclick="submit()"
                                value="locations">
                            <label class="text-sm text-stone-100 ml-2" for="locations">Free Pemasangan Lain-Lain</label>
            ...
            <div class="w-[1100px] mt-4">
                @if (request('orderType'))
                    ...
                    @elseif (request('orderType') == 'sales')
                        @include('install-orders.order-table')
