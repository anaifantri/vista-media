                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr class="bg-teal-100 h-10">
                            ...
                            <th class="text-teal-700 border text-sm text-center w-28">Jadwal Pasang</th>
                            <th class="text-teal-700 border text-sm text-center w-28">Type</th>
                            <th class="text-teal-700 border text-sm text-center">Tema/Design</th>
                            <th class="text-teal-700 border text-sm text-center w16">Qty</th>
                            <th class="text-teal-700 border text-sm text-center w-28">Ukuran</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($install_orders as $order)
                            <tr>
                                ...
                                <td class="text-teal-700 p-1 border text-sm text-center">{{ $order->install_at }}</td>
