...
@section('container')
    <div class="flex justify-center mt-10">
        <form class="md:flex" method="post" action="/media-sizes/{{ $media_size->id }}" enctype="multipart/form-data">
            @method('put')
            @csrf
                ...
                <div class="p-3 py-5 w-full">
                    ...
                    <div class="mt-5 w-full">
                        ...
                        <div class="flex mt-5">
                            ...
                            <a href="/media-sizes" class="flex items-center justify-center btn-danger mx-1">
