...
@section('container')
    ...
    <div class="mt-10 z-0">
                                            ...
                                            <form action="/media-sizes/{{ $size->id }}" method="post" class="d-inline m-1">
                                                ...
                                                @if ($size->locations()->exists())
                                                    <button
                                                        ...
                                                        onclick="return confirm('Berelasi dengan {{ count($size->locations) }} data pada tabel data lokasi, apakah anda yakin ingin menghapus data ukuran {{ $size->size }} sekaligus menghapus data-data yang berelasi?')">
        ...
        <div class="flex justify-center text-teal-900 mt-2">
            {{-- {{ $media_sizes->links('dashboard.layouts.pagination') }} --}}
