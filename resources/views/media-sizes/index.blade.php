    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="bg-stone-400 h-10">
                                <th class="text-stone-900 border border-stone-900 text-sm w-12 text-center">No.</th>
                                ...
                                <th class="text-stone-900 border border-stone-900 text-sm text-center">Katagori</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-36">Action</th>
                            </tr>
                        </thead>
            ...
            <div class="flex justify-center text-stone-100 mt-2">
                {!! $media_sizes->appends(Request::query())->render('dashboard.layouts.pagination') !!}
            </div>
            <!-- View end -->
        </div>
    </div>
