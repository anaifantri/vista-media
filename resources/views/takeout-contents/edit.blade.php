...
@section('container')
    ...
    @endphp
    <!-- Form Editstart -->
    <form action="/workshop/takeout-contents/{{ $take_out_content->id }}" method="post" enctype="multipart/form-data">
        @method('put')
        @csrf
        ...
        <div class="flex justify-center pl-14 py-10 bg-stone-800">
            <div class="p-4 w-[1000px] border rounded-lg bg-stone-700">
                <div class="flex items-center justify-center border-b p-1">
                    <h4 class="text-xl font-semibold tracking-wider text-stone-100 w-[950px]">EDIT DATA TAKE OUT MATERI
                        VIDEOTRON
                    </h4>
                    <div class="flex justify-end w-full">
                        <a href="/workshop/takeout-contents/{{ $take_out_content->id }}"
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                ...
                                <input name="take_out_date"
                                    ...
                                    value="{{ $take_out_content->take_out_date }}" type="date" required>
                            </div>
                            @error('take_out_date')
                            ...
                            <div class="mt-2">
                                ...
                                <textarea
                                    ...
                                    name="notes" rows="3" placeholder="Input Catatan" required>{{ $take_out_content->notes }}</textarea>
                            </div>
                            @error('notes')
                                <div class="text-red-600 flex mx-2">
                                    {{ $message }}
