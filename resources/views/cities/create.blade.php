            ...
            <div class="flex justify-center w-full ">
                <div class="flex w-[900px] border-b">
                    ...
                    <div class="flex w-full justify-end items-center">
                        ...
                        <a class="flex justify-center items-center mx-1 btn-danger" href="/city">
                            <svg class="fill-current w-5 mx-1" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24">
                                <path
                ...
                <div class="w-[300px]">
                    ...
                    <div class="flex mx-2 mt-3">
                        ...
                        <input id="code" name="code"
                            class="input-area w-[160px] @error('code') is-invalid @enderror" value="{{ old('code') }}"
                    ...
                    <div class="flex
                        ...
                        <input id="zoom" name="zoom" class="input-area w-[160px] in-out-spin-none" type="number"
                            min="0" placeholder="Input Zoom" onkeyup="setZoom(this)" required>
                    </div>
                </div>
                <!-- Create New City end -->
                <!-- Maps City start -->
