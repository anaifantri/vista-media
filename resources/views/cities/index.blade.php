    ...
    <div class="flex justify-center p-10">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="bg-stone-400  h-10">
                                ...
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-28">Area</th>
                                ...
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-16">Kode</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-24">Latitude</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-24">Longitude</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-16">Zoom</th>
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-24">Dibuat Oleh</th>
            ...
            <div class="flex justify-center text-stone-100 mt-2">
                {!! $cities->appends(Request::query())->render('dashboard.layouts.pagination') !!}
            </div>
        </div>
        <!-- Pagination end -->
    </div>
