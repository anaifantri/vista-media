                        ...
                        @foreach ($quotation_agreements as $agreement)
                            @if ($loop->iteration == 1)
                                <div class="divImage">
                                        ...
                                        <div class="flex items-center">
                                            <div class="w-64">
                                                <div class="flex">
                                                    ...
                                                    <label
                                                        class="text-sm text-yellow-400 ml-2 w-40">{{ date('d', strtotime($agreement->created_at)) }}
                                                        {{ $bulan[(int) date('m', strtotime($agreement->created_at))] }}
                                                        {{ date('Y', strtotime($agreement->created_at)) }}</label>
                                                </div>
                                                <div class="flex">
                                    ...
                                    <img class="lg-photo-product" src="{{ asset('storage/' . $agreement->image) }}"
                                        alt="">
                                </div>
                            @else
