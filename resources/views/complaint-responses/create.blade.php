...
@section('container')
    ...
    @endphp
    <!-- Form Create start -->
    <form action="/workshop/complaint-responses" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="flex justify-center pl-14 py-10 bg-stone-800">
            <div class="p-4 w-[1000px] border rounded-lg bg-stone-700">
                <div class="flex items-center justify-center border-b p-1">
                    <h4 class="text-xl font-semibold tracking-wider text-stone-100 w-[950px]">TAMBAH DATA KRESPON KOMPLAIN
                        KLIEN</h4>
                    <div class="flex justify-end w-full">
                        <a href="/workshop/complaint-responses/create"
                    ...
                    <div class="border rounded-lg p-2 bg-stone-300">
                        ...
                        <div class="mt-2">
                            ...
                            <textarea class="flex w-[450px] bg-neutral-50 text-sm font-semibold text-stone-900 border rounded-lg p-1 outline-none"
                                rows="3" disabled>{{ $complaint->notes }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="border rounded-lg p-2 bg-stone-200 w-full">
                        <div>
                            ...
                            <input name="response_date"
                                ...
                                value="{{ old('response_date') }}" type="date" required>
                        </div>
                        @error('response_date')
                        ...
                        <div class="mt-2">
                            ...
                            <textarea
                                ...
                                name="problem" rows="3" placeholder="Input Permasalahan" required>{{ old('problem') }}</textarea>
                        </div>
                        @error('problem')
                            <div class="text-red-600 flex mx-2">
                                {{ $message }}
                    ...
                    <div class="border rounded-lg p-2 bg-stone-200 w-full">
                        <div class="mt-2">
                            ...
                            <textarea
                                ...
                                name="problem_solving" rows="5" placeholder="Input Penyelesaian / Perbaikan" required>{{ old('problem_solving') }}</textarea>
                        </div>
