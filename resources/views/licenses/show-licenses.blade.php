        ...
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex p-1 w-full border-b">
                ...
                <div class="flex w-full justify-end items-center">
                    <a class="flex justify-center items-center mx-1 btn-primary" href="/media/licenses">
                            ...
                            <tr>
                                ...
                                <td class="text-stone-900 border border-stone-900 text-xs px-1 text-center">
                                    @if ($prinsip->start_at)
                                        ...
                                        {{ date('Y', strtotime($prinsip->start_at)) }}
                                    @else
                                        -
                                    @endif
                                </td>
                                <td class="text-stone-900 border border-stone-900 text-xs px-1 text-center">
                                    @if ($prinsip->end_at)
                                        ...
                                        {{ date('Y', strtotime($prinsip->end_at)) }}
                                    @else
                                        -
                                    @endif
                                </td>
                                <td class="text-stone-900 border border-stone-900 text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaEdit')
                                                    <a href="/media/licenses/{{ $prinsip->id }}/edit"
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaDelete')
                                                    <form action="/media/licenses/{{ $prinsip->id }}" method="post"
                                                        class="d-inline m-1">
                                                        @method('delete')
                                                        @csrf
                                                        <button
                                                            class="index-link text-white w-7 h-5 bg-red-500 rounded-md hover:bg-red-600"
                                                            onclick="return confirm('Apakah anda yakin ingin menghapus data izin prinsip dengan nomor {{ $prinsip->number }} ?')">
                                ...
                                <td class="text-stone-900 border border-stone-900 text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaEdit')
                                                    <a href="/media/licenses/{{ $pbg->id }}/edit"
                                                        class="index-link text-white w-8 h-5 rounded bg-amber-400 hover:bg-amber-500 drop-shadow-md">
                                                        <svg class="fill-current w-5" clip-rule="evenodd" fill-rule="evenodd"
                                                            stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaDelete')
                                                    <form action="/media/licenses/{{ $pbg->id }}" method="post"
                                                        class="d-inline m-1">
                                                        @method('delete')
                                                        @csrf
                                                        <button
                                                            class="index-link text-white w-7 h-5 bg-red-500 rounded-md hover:bg-red-600"
                                                            onclick="return confirm('Apakah anda yakin ingin menghapus data izin PBG/SLF dengan nomor {{ $pbg->number }} ?')">
                                                            <svg class="w-4 fill-current" xmlns="http://www.w3.org/2000/svg"
                                                                width="24" height="24" viewBox="0 0 24 24">
                                                                <title>DELETE</title>
                                                                <path
                                ...
                                <td class="text-stone-900 border border-stone-900 text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaEdit')
                                                    <a href="/media/licenses/{{ $ipr->id }}/edit"
                                                        class="index-link text-white w-8 h-5 rounded bg-amber-400 hover:bg-amber-500 drop-shadow-md">
                                                        <svg class="fill-current w-5" clip-rule="evenodd" fill-rule="evenodd"
                                                            stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaDelete')
                                                    <form action="/media/licenses/{{ $ipr->id }}" method="post"
                                                        class="d-inline m-1">
                                                        @method('delete')
                                                        @csrf
                                                        <button
                                                            class="index-link text-white w-7 h-5 bg-red-500 rounded-md hover:bg-red-600"
                                                            onclick="return confirm('Apakah anda yakin ingin menghapus data izin IPR dengan nomor {{ $ipr->number }} ?')">
                                                            <svg class="w-4 fill-current" xmlns="http://www.w3.org/2000/svg"
                                                                width="24" height="24" viewBox="0 0 24 24">
                                                                <title>DELETE</title>
                                                                <path
                            ...
                            <tr>
                                ...
                                <td class="text-stone-900 border border-stone-900 text-xs px-1 text-center">
                                    @if ($skpd->start_at)
                                        ...
                                        {{ date('Y', strtotime($skpd->start_at)) }}
                                    @else
                                        -
                                    @endif
                                </td>
                                ...
                                <td class="text-stone-900 border border-stone-900 text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaEdit')
                                                    <a href="/media/licenses/{{ $skpd->id }}/edit"
                                                        class="index-link text-white w-8 h-5 rounded bg-amber-400 hover:bg-amber-500 drop-shadow-md">
                                                        <svg class="fill-current w-5" clip-rule="evenodd" fill-rule="evenodd"
                                                            stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaDelete')
                                                    <form action="/media/licenses/{{ $skpd->id }}" method="post"
                                                        class="d-inline m-1">
                                                        @method('delete')
                                                        @csrf
                                                        <button
                                                            class="index-link text-white w-7 h-5 bg-red-500 rounded-md hover:bg-red-600"
                                                            onclick="return confirm('Apakah anda yakin ingin menghapus data SKPD dengan nomor {{ $skpd->number }} ?')">
                                                            <svg class="w-4 fill-current" xmlns="http://www.w3.org/2000/svg"
                                                                width="24" height="24" viewBox="0 0 24 24">
                                                                <title>DELETE</title>
                                                                <path
                            ...
                            <tr>
                                ...
                                <td class="text-stone-900 border border-stone-900 text-xs px-1 text-center">
                                    @if ($sspd->start_at)
                                        ...
                                        {{ date('Y', strtotime($sspd->start_at)) }}
                                    @else
                                        -
                                    @endif
                                </td>
                                ...
                                <td class="text-stone-900 border border-stone-900 text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaEdit')
                                                    <a href="/media/licenses/{{ $sspd->id }}/edit"
                                                        class="index-link text-white w-8 h-5 rounded bg-amber-400 hover:bg-amber-500 drop-shadow-md">
                                                        <svg class="fill-current w-5" clip-rule="evenodd" fill-rule="evenodd"
                                                            stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaDelete')
                                                    <form action="/media/licenses/{{ $sspd->id }}" method="post"
                                                        class="d-inline m-1">
                                                        @method('delete')
                                                        @csrf
                                                        <button
                                                            class="index-link text-white w-7 h-5 bg-red-500 rounded-md hover:bg-red-600"
                                                            onclick="return confirm('Apakah anda yakin ingin menghapus data SSPD dengan nomor {{ $sspd->number }} ?')">
                                                            <svg class="w-4 fill-current" xmlns="http://www.w3.org/2000/svg"
                                                                width="24" height="24" viewBox="0 0 24 24">
                                                                <title>DELETE</title>
                                                                <path
