...
@section('container')
    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex p-1 w-full border-b">
                <!-- Title start -->
                <h1 class="index-h1">DAFTAR DATA PERIZINAN YANG MASIH BERLAKU</h1>
                <!-- Title end -->
            </div>
            <div>
                <!-- Form search start -->
                <form action="/media/active-licenses/">
    ...
    <input id="saveName" type="text" value="LIST PERIZINAN MASIH BERLAKU" hidden>
    <!-- Container end -->
        ...
        $(document).ready(function() {
            $('#btnExportExcel').on('click', function() {
                $('#exportExcelTable').table2excel({
                    filename: "List Perizinan Masih Berlaku.xls"
                });
            });
        });
    </script>
