...
@section('container')
    <form method="post" action="/printing-prices/{{ $printing_price->id }}" enctype="multipart/form-data">
        @method('put')
        @csrf
            ...
            <div class="p-4 w-[350px] h-[500px] border rounded-lg">
                ...
                <div>
                    ...
                    <div class="flex justify-center mt-5">
                        ...
                        <a href="/printing-prices" class="flex items-center justify-center btn-danger mx-1">
