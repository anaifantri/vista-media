                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr class="bg-teal-100 h-10">
                            ...
                            <th class="text-teal-700 border text-sm text-center w-60">
                                <button class="flex justify-center items-center w-60">@sortablelink('name', 'Nama Group')
                            ...
                            <th class="text-teal-700 border text-sm text-center">Member</th>
                            <th class="text-teal-700 border text-sm text-center w-24">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
                            $number = 1 + ($client_groups->currentPage() - 1) * $client_groups->perPage();
                        @endphp
                        @foreach ($client_groups as $group)
                            ...
                            <tr>
                                ...
                                <td class="text-teal-700 border text-sm text-center">{{ $group->group }}</td>
                                ...
                                <td class="text-teal-700 border text-sm text-center">
                                    <div class="flex justify-center items-center">
                                        <a href="/marketing/client-groups/{{ $group->id }}"
