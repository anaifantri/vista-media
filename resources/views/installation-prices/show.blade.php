...
@section('container')
    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="border rounded-lg h-max w-[315px] p-4 bg-stone-300">
            <div class="flex justify-center items-center mb-3 w-full border-b">
                <h4 class="text-2xl font-semibold tracking-wider text-stone-900">Detail Harga Pasang</h4>
            </div>
            <div class="flex justify-center mt-4 w-full">
                <div>
                    ...
                    <div class="border-b mt-2">
                        <label class="text-sm text-stone-900">Tipe</label>
                        <h6 class="text-base font-semibold text-stone-900">
