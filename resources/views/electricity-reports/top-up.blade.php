...
@section('container')
    @php
        ...
        if (fmod(count($electricity_top_ups), 25) == 0) {
            $pageQty = count($electricity_top_ups) / 25;
        } else {
            $pageQty = (count($electricity_top_ups) - fmod(count($electricity_top_ups), 25)) / 25 + 1;
        }
    @endphp
    <!-- Container start -->
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            ...
            <div>
                <!-- Form search start -->
                <form action="/workshop/electricity-reports/topup">
                            ...
                            <div class="flex w-full justify-end">
                                <div>
                                    ...
                                    <div class="flex justify-center w-96">
                                        <label class="text-lg text-center font-bold">LIST DATA PENGISIAN LISTRIK</label>
                                    </div>
                                    <div class="flex justify-center w-96">
                            ...
                            <div class="flex items-center border rounded-lg p-2 mt-6">
                                ...
                                <div class="flex w-full justify-end">
                                    <div>
                                        ...
                                        <div class="flex justify-center w-96">
                                            <label class="text-lg text-center font-bold">LIST DATA PENGISIAN PULSA
                                                LISTRIK</label>
                                        </div>
                                        <div class="flex justify-center w-96">
                                            <label class="text-sm text-center"></label>
    ...
    @else
        <input id="saveName" type="text"
            value="LIST PENGISIAN LISTRIK - {{ $bulan_full[(int) date('m')] }} - {{ date('Y') }}" hidden>
    @endif
    <!-- Container end -->
