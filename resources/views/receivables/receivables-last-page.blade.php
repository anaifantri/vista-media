        ...
        <div class="flex w-full justify-end">
            <div>
                ...
                <div class="flex mt-4 justify-center w-72 border rounded-md">
                    ...
                    @else
                        <label id="labelPeriode" class="month-report text-md font-semibold text-center">BERDASARKAN
                            INVOICE</label>
                    @endif
                </div>
    ...
    <div class="h-[740px] mt-2">
        <table class="table-auto w-full">
            ...
            <tbody>
                ...
                @endforeach
                <tr>
                    <td class="border border-black text-md text-right align-top font-semibold px-2" colspan="7">TOTAL
                    </td>
