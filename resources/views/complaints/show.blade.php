    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="p-4 w-[1000px] border rounded-lg bg-stone-700">
            <div class="flex items-center justify-center border-b p-1">
                <h4 class="text-xl font-semibold tracking-wider text-stone-100 w-[950px]">DETAIL KOMPLAIN DARI KLIEN</h4>
                <div class="flex justify-end w-full">
                    <a href="/workshop/complaints" class="flex items-center justify-center btn-primary mx-1">
                    ...
                    @canany(['isAdmin', 'isWorkshop', 'isMedia', 'isAccounting', 'isMarketing'])
                        @can('isComplaint')
                            @can('isWorkshopDelete')
                                <form action="/workshop/complaints/{{ $complaint->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            <textarea class="flex w-[450px] bg-neutral-50 text-sm font-semibold text-stone-900 border rounded-lg p-1 outline-none"
                                rows="3">{{ $complaint->notes }}</textarea>
                        </div>
                        <div>
