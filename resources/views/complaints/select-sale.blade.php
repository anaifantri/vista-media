...
@section('container')
    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex p-1 w-full border-b">
                <!-- Title start -->
                <h1 class="index-h1">PILIH PENJUALAN</h1>
                @canany(['isAdmin', 'isWorkshop', 'isMedia', 'isAccounting', 'isMarketing'])
                    ...
                    @endcan
                @endcanany
                <a href="/workshop/complaints" class="flex items-center justify-center btn-danger mx-1">
            ...
            <div>
                <!-- Form search start -->
                <form action="/workshop/complaints/create">
                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr class="bg-stone-400 h-8">
                            ...
                            <th class="text-stone-900 border border-stone-900 w-40 text-xs text-center">
                                <button class="flex justify-center items-center w-40">@sortablelink('number', 'No. Penjualan')
                            ...
                            <th class="text-stone-900 border border-stone-900 text-xs text-center">
                                Lokasi</th>
                            <th class="text-stone-900 border border-stone-900 text-xs text-center w-220">
                                Ukuran</th>
                    ...
                    <tbody class="bg-stone-200">
                        @foreach ($sales as $sale)
                            ...
                            <tr>
                                ...
                                <td class="text-stone-900 border border-stone-900 text-xs text-center">
                                    <input type="radio" name="rbSale" value="{{ $sale->id }}"
                                        onclick="rbSaleAction(this)">
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
    ...
    <script>
        ...
        rbSaleAction = (sel) => {
            ...
            linkCreate.setAttribute('href', '/complaints/create/' + saleId);
        }
