    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex p-1 w-full border-b">
                <!-- Title start -->
                <h1 class="index-h1">Daftar Komplain Dari Klien</h1>
                <!-- Title end -->
                <div class="flex items-center w-full justify-end">
                    @canany(['isAdmin', 'isWorkshop', 'isMedia', 'isAccounting', 'isMarketing'])
                        @can('isComplaint')
                            @can('isWorkshopCreate')
                                <a href="/workshop/complaints/create" title="Tambah Data Upload" class="index-link btn-primary mx-1">
            ...
            <div>
                <!-- Form search start -->
                <form action="/workshop/complaints">
                    <div class="flex mt-1">
                        <div class="w-36">
            ...
            <div class="w-[1550px] mt-2">
                <table class="table-auto w-full">
                    ...
                    <tbody class="bg-stone-200">
                        @php
                            $number = 1 + ($complaints->currentPage() - 1) * $complaints->perPage();
                        @endphp
                        @foreach ($complaints as $complaint)
                            ...
                            <tr>
                                ...
                                <td class="text-stone-900 border border-stone-900 text-sm text-center">
                                    @if ($complaint->complaint_response)
                                        Tertangani
                                    @else
                                        Open
                                    @endif
                                ...
                                <td class="text-stone-900 border border-stone-900 text-sm text-center">
                                    <div class="flex justify-center items-center">
                                        <a href="/workshop/complaints/{{ $complaint->id }}"
                                        ...
                                        @canany(['isAdmin', 'isMedia', 'isMarketing', 'isWorkshop', 'isOwner',
                                            ...
                                            @can('isComplaint')
                                                @can('isWorkshopEdit')
                                                    <a href="/workshop/complaints/{{ $complaint->id }}/edit"
                                        ...
                                        @canany(['isAdmin', 'isMedia', 'isMarketing', 'isWorkshop', 'isOwner',
                                            ...
                                            @can('isComplaint')
                                                @can('isWorkshopDelete')
                                                    <form action="/workshop/complaints/{{ $complaint->id }}" method="post"
                                                        class="d-inline m-1">
                                                        @method('delete')
                                                        @csrf
                                                        <button
            ...
            <div class="flex justify-center text-stone-100 mt-2">
                {!! $complaints->appends(Request::query())->render('dashboard.layouts.pagination') !!}
            </div>
            <!-- Pagination end -->
        </div>
    </div>
