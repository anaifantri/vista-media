...
@section('container')
    @php
        ...
        if (fmod(count($complaints), 30) == 0) {
            $totalPages = count($complaints) / 30;
        } else {
            $totalPages = (count($complaints) - fmod(count($complaints), 30)) / 30 + 1;
        }
    @endphp
    <!-- Container start -->
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex p-1 w-full border-b">
                <!-- Title start -->
                <h1 class="index-h1">List Komplain Dari Klien</h1>
                <!-- Title end -->
                                    ...
                                    <table class="table-auto w-full mt-4">
                                        <thead>
                                            <tr class="bg-stone-400 h-8">
                                                ...
                                                <th
                                                    class="text-stone-900 border border-stone-900 text-sm text-center w-32">
                                                    No. Komplain
                                                </th>
                                                <th
                                                ...
                                                <th
                                                    ...
                                                    Lokasi</th>
                                                <th
                                                    class="text-stone-900 border border-stone-900 text-sm text-center w-40">
                                                    Client</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            @if ($complaint->complaint_response)
                                                                {{ $complaint->complaint_response->problem_solving }}
                                                            @else
                                                                -
                                                            @endif
                                                        </td>
    ...
    <input id="saveName" type="text" value="LIST KOMPLAIN KLIEN" hidden>
    <!-- Container end -->
    <!-- Script start -->
        ...
        $(document).ready(function() {
            $('#btnExportExcel').on('click', function() {
                $('#exportExcelTable').table2excel({
                    filename: "List Komplain Klien.xls"
                });
            });
        });
    </script>
