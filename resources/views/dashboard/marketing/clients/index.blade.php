                    ...
                    <thead>
                        <tr class="bg-teal-100 h-10">
                            ...
                            <th class="text-teal-700 border text-sm text-center w-36">
                                <button class="flex justify-center items-center w-36">@sortablelink('name', 'Nama Klien')
                            ...
                            {{-- <th class="text-teal-700 border text-sm text-center w-48">
                                <button class="flex justify-center items-center w-48">@sortablelink('company', 'Nama Perusahaan')
                                    <svg class="fill-current w-3 ml-1" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z" />
                                    </svg>
                            ...
                            <th class="text-teal-700 border text-sm text-center w-36">
                                <button class="flex justify-center items-center w-36">@sortablelink('category', 'Katagori')
                                    <svg class="fill-current w-3 ml-1" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z" />
                                    </svg>
                            ...
                            <th class="text-teal-700 border text-sm text-center w-52">Email</th>
                    ...
                    <tbody>
                        @foreach ($clients as $client)
                            <tr>
                                ...
                                {{-- <td class="text-teal-700 border text-sm text-center">{{ $client->company }}</td> --}}
                                <td class="text-teal-700 border text-sm px-1">{{ $client->address }}</td>
                                <td class="text-teal-700 border text-sm text-center">{{ $client->client_category->name }}
                                </td>
                                @if ($client->email)
                                    <td class="text-teal-700 border text-sm text-center">{{ $client->email }}</td>
                                @else
                                    <td class="text-teal-700 border text-sm text-center">-</td>
                                @endif
                                <td class="text-teal-700 border text-sm text-center">{{ $client->phone }}</td>
