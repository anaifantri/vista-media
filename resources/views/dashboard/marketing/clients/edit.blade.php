...
@section('container')
    <div class="flex relative items-center">
        <div class="flex">
            <form class="flex" method="post" action="/dashboard/clients/{{ $client->id }}" enctype="multipart/form-data">
                @method('put')
                @csrf
                    ...
                    <div class="p-3 py-3 w-full">
                        ...
                        <div class="mt-5 w-full">
                            ...
                            <div class="flex mt-5">
                                ...
                                <a href="/dashboard/clients" class="flex items-center justify-center btn-danger mx-1">
    ...
    <script>
        ...
        for (i = 0; i < arrayCategory.length; i++) {
            ...
            if (oldCategory.value == arrayCategory[i]) {
