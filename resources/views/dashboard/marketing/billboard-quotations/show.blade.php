                ...
                <div class="flex justify-center">
                    <div class="flex mx-1">
                        <div class="">
                            ...
                            <div class="flex mt-1">
                                <div class="mt-1">
                                    <label class="text-sm xl:text-md 2xl:text-lg text-teal-700">Dibuat oleh</label>
                                    <label
                                        class="flex w-36 xl:w-48 2xl:w-56  text-sm xl:text-md 2xl:text-lg font-semibold text-teal-900 border rounded-lg p-1">{{ $billboard_quotation->user->name }}</label>
                                </div>
                            </div>
                            <div class="flex mt-1">
                                <div class="mt-1">
                                    <label class="text-sm xl:text-md 2xl:text-lg text-teal-700">Tanggal di buat</label>
                                    <label
                                        class="flex w-36 xl:w-48 2xl:w-56  text-sm xl:text-md 2xl:text-lg font-semibold text-teal-900 border rounded-lg p-1">{{ date('d F Y', strtotime($billboard_quotation->created_at)) }}</label>
                                </div>
                            </div>
                            <div class="flex mt-1">
                                <div class="mt-1">
                                    <label class="text-sm xl:text-md 2xl:text-lg text-teal-700">Tanggal dikirim</label>
                                    <label
                                        class="flex w-36 xl:w-48 2xl:w-56  text-sm xl:text-md 2xl:text-lg font-semibold text-teal-900 border rounded-lg p-1">
                                        @if ($billboard_quotation->send_at)
                                            {{ date('d F Y', strtotime($billboard_quotation->send_at)) }}
                                        @else
                                            -
                                        @endif
                                    </label>
                            ...
                            <div class="flex mt-1">
                                <div class="mt-1">
                                    ...
                                    <label
                                        class="flex w-36 xl:w-48 2xl:w-56  text-sm xl:text-md 2xl:text-lg font-semibold text-teal-900 p-1">-</label>
                                </div>
                            </div>
                            <div class="flex justify-start mt-5">
                                ...
                                {{-- <a class="flex justify-center items-center ml-1 xl:mx-2 2xl:h-10 btn-warning"
                                    href="/dashboard/marketing/billboard-quotations/{{ $billboard_quotation->id }}/edit"> --}}
                                <a class="flex justify-center items-center ml-1 xl:mx-2 2xl:h-10 btn-warning"
