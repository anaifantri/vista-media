                                ...
                                <div class="flex justify-center">
                                    <div id="tableWidth" class="w-[650px]">
                                        <table id="" class="table-fix mt-2 w-full">
                                            <thead>
                                                <tr>
                                                    <th class="text-[0.7rem] text-teal-700 border w-max" rowspan="2">No
                                                    </th>
                                                    <th class="text-[0.7rem] text-teal-700 border w-16" rowspan="2">
                                                        Kode
                                                    </th>
                                                    <th class="text-[0.7rem] text-teal-700 border w-52" rowspan="2">
                                                        Lokasi
                                                    </th>
                                                    <th class="text-[0.7rem] text-teal-700 border w-max" colspan="3">
                                                        Deskripsi
                                                    </th>
                                                    <th class="text-[0.7rem] text-teal-700 border w-16" colspan="5">
                                                        Harga
                                                    </th>
                                                </tr>
                                                <tr>
