            ...
            <div class="flex w-full justify-center">
                <div class="flex w-[950px] justify-end">
                    ...
                    <a class="flex justify-center items-center ml-1 xl:mx-2 2xl:h-10 btn-danger"
                        href="/dashboard/marketing/sales/{{ $billboard_sale->id }}">
                            ...
                            <div id="billboardTableWidth" class="w-[725px]">
                                <table id="billboardTable" class="table-fix mt-2 w-full">
                                    ...
                                    <tbody id="billboardsTBody">
                                        ...
                                        $usedPrint = 0;
                                        $usedInstall = 0;
                                        $geeks = $billboard_sale->billboard->size->size;
                                        ...
                                        @foreach ($w_o_installs as $woInstall)
                                            ...
                                            @endif
                                        @endforeach
                                        <input class="flex outline-none text-sm text-teal-700 w-28 ml-2 h-6" readonly
                                            type="number" name="diffPrint" id="diffPrint"
                                            value="{{ $billboard_sale->free_print - $usedPrint }}">
                                        @if ($billboard_sale->free_instalation - $usedInstall == 0 && $billboard_sale->free_print - $usedPrint == 0)
                                            <tr>
                                                <input id="usedPrint" type="text" value="{{ $usedPrint }}" hidden>
                                                <input id="freePrint" type="text"
                                                    value="{{ $billboard_sale->free_print }}" hidden>
                                                <input id="usedInstall" type="text" value="{{ $usedInstall }}"
                                                    hidden>
                                                <input id="freeInstall" type="text"
                                                    value="{{ $billboard_sale->free_instalation }}" hidden>
                                                ...
                                                <td class="text-xs text-teal-700 border p-1">Jl. Raya Uluwatu -
                                                    Dekat
                                                    GWK
                                                </td>
                                                    ...
                                                    <div class="ml-1 mt-1">
                                                        ...
                                                        <select id="printing_product" name="printing_product"
                                                            ...
                                                            @foreach ($printing_products as $printing_product)
                                                                @if ($printing_product->type == $billboard_sale->billboard->lighting)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-xs text-teal-700 border text-center">
                                                    <div id="installation_product" class="ml-1 mt-1">
                                                        {{ $billboard_sale->billboard->lighting }}
                                                    </div>
                                                </td>
                                                ...
                                                @foreach ($installation_prices as $installation_price)
                                                    @if ($installation_price->type == $billboard_sale->billboard->lighting)
                                                        <?php
                                        ...
                                        @elseif ($billboard_sale->free_instalation - $usedInstall > 0 && $billboard_sale->free_print - $usedPrint == 0)
                                            <tr>
                                                <input id="usedPrint" type="text" value="{{ $usedPrint }}" hidden>
                                                <input id="freePrint" type="text"
                                                    value="{{ $billboard_sale->free_print }}" hidden>
                                            ...
                                            <tr>
                                                ...
                                                <td id="totalInstal" class="text-xs text-teal-700 border text-right p-1">
                                                    Free ke
                                                    {{ $usedInstall + 1 }} dari
                                                    {{ $billboard_sale->free_instalation }}
                                                    <input class="text-xs w-16 text-teal-700 outline-none text-right"
                                                        type="number" id="total_install" name="total_install"
                                                        min="0" value="{{ $totalInstall }}" hidden>
                                                </td>
