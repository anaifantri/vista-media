<div id="modal" name="modal" class="absolute justify-center top-0 w-full h-full bg-black bg-opacity-90 z-50 hidden">
    <div class="mt-10">
        ...
        <form class="flex justify-center" action="/dashboard/marketing/print-instal-quotations" method="post"
            ...
            <input type="text" id="billboard_code" name="billboard_code" value="{{ $sale->billboard->code }}" hidden>
            ...
            <input type="text" id="products" name="products" value="{{ old('products') }}" hidden>
                        ...
                        <div class="w-[725px] mt-2">
                            ...
                            <div class="flex">
                                ...
                                <label id="subjectBillboard"
                                    class="ml-1 text-sm text-black font-semibold flex">Penawaran
                            ...
                            <div class="flex mt-2">
                                ...
                                @elseif ($sale->free_instalation - $usedInstall > 0 && $sale->free_print - $usedPrint == 0)
                                    <textarea id="bodyTop" class="ml-1 w-[721px] outline-none text-sm" readonly>Bersama ini kami menyampaikan surat penawaran biaya pemasangan materi billboard dengan spesifikasi sebagai berikut :</textarea>
                                @elseif ($sale->free_instalation - $usedInstall == 0 && $sale->free_print - $usedPrint > 0)
                                    <textarea id="bodyTop" class="ml-1 w-[721px] outline-none text-sm" readonly>Bersama ini kami menyampaikan surat penawaran biaya cetak materi billboard dengan spesifikasi sebagai berikut :</textarea>
                                @endif
                                @error('body_top')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    ...
                                    <tbody id="billboardsTBody">
                                        ...
                                        @if ($sale->free_instalation - $usedInstall == 0 && $sale->free_print - $usedPrint == 0)
                                            <tr>
                                                ...
                                                <td id="widePrint"
                                                    class="text-xs text-teal-700 border text-center p-1">
                                                    {{ $wide }}
                                                </td>
                                                <td class="text-xs text-teal-700 border text-center">
                                                ...
                                                <td id="totalPrint"
                                                    class="text-xs text-teal-700 border text-right p-1">
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    @if ($installation_price->type == $sale->billboard->lighting)
                                                        ...
                                                        <td class="text-xs text-teal-700 border text-center">
                                                            <input
                                                                ...
                                                                min="0"
                                                                value="{{ $installation_price->price }}">
                                                        </td>
                                                    @endif
                                                @endforeach
                                                <td id="totalInstal"
                                        ...
                                        @elseif ($sale->free_instalation - $usedInstall > 0 && $sale->free_print - $usedPrint == 0)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-xs text-teal-700 border text-center">Free
                                                    <input class="text-xs w-16 text-teal-700 outline-none text-right"
                                                        type="number" id="instal_price" name="instal_price"
                                                        min="0" value="0" hidden>
                                                </td>
                                                <td id="totalInstal"
                                                    class="text-xs text-teal-700 border text-right p-1">Free ke
