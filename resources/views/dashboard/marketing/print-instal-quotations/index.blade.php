    ...
    <div class="mt-10 z-0">
        <div class="flex justify-center w-full">
            <div class="w-[1200px] p-2">
                <div class="flex">
                    <h1 class="index-h1"> Daftar Penawaran Cetak dan Pasang</h1>
                    <div class="flex border-b">
                        <a href="/dashboard/marketing/print-instal-quotations/create" class="index-link btn-primary">
                ...
                <form class="flex mt-2" action="/dashboard/marketing/print-instal-quotations/">
                    <div class="flex">
                        ...
                        @foreach ($print_instal_quotations as $print_instal_quotation)
                            ...
                            <tr>
                                ...
                                <td class="text-teal-700 border text-sm text-center">
                                    {{ $print_instal_quotation->client->name }}
                                </td>
                                <td class="text-teal-700 border text-sm text-center">
                                ...
                                <td class="text-teal-700 border text-sm text-center">
                                    {{ $print_instal_quotation->user->name }}
                                </td>
                                <td class="text-teal-700 border text-sm text-center align-center">
                                    <div class="flex justify-center">
                                        <a href="/dashboard/marketing/print-instal-quotations/{{ $print_instal_quotation->id }}"
                                    ...
                                    {{-- <a href="/dashboard/marketing/print-instal-quotations/{{ $print_instal_quotation->id }}/edit"
                                ...
                                <form action="/dashboard/marketing/print-instal-quotations/{{ $print_instal_quotation->id }}"
                                    method="post" class="flex m-auto">
                                    @method('delete')
                                    @csrf
                                    <button
                                        class="index-link text-white w-8 h-5 rounded bg-red-600 hover:bg-red-700 drop-shadow-md mr-1"
                                        onclick="return confirm('Apakah anda yakin ingin menghapus quotation {{ $print_instal_quotation->number }} ?')">
                                        <svg class="fill-current w-5" clip-rule="evenodd" fill-rule="evenodd"
                                            stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
