            ...
            <table class="table-auto w-full lg:w-[1100px] mb-6">
                <thead>
                    <tr class="index-tr items-center h-10 bg-teal-100 border-t">
                        <th class="index-td text-[0.65rem] w-8">No.</th>
                        <th class="index-td text-[0.65rem] w-20">
                            @sortablelink('number', 'Nomor')
                            <svg class="fill-current w-3 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z" />
                            </svg>
                        </th>
                        <th class="index-td text-[0.65rem] w-36">Data Reklame</th>
                        <th class="index-td text-[0.65rem] w-20">Klien</th>
                        <th class="index-td text-[0.65rem] w-20">Deskripsi</th>
                        <th class="index-td text-[0.65rem] w-36">Harga</th>
                        <th class="index-td text-[0.65rem] w-24">Penawaran</th>
                        <th class="index-td text-[0.65rem] w-28">Approval</th>
                        <th class="index-td text-[0.65rem] w-20">PO/SPK</th>
                        <th class="index-td text-[0.65rem] w-20">Agreement</th>
                        <th class="index-td text-[0.65rem] w-28">Tanggal Dibuat</th>
                        <th class="index-td text-[0.65rem] w-24">Dibuat Oleh</th>
                        <th class="index-td text-[0.65rem] w-24">Action</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($sales as $sale)
                        <tr class="index-tr">
                            <td class="index-td text-[0.65rem] w-8 text-center"></td>
                            <td class="index-td text-[0.65rem] w-20"></td>
                            <td class="index-td text-[0.65rem] w-36"></td>
                            <td class="index-td text-[0.65rem] w-20"></td>
                            <td class="index-td text-[0.65rem] w-20"></td>
                            <td class="index-td text-[0.65rem] w-36"></td>
                            <td class="index-td text-[0.65rem] w-24"></td>
                            <td class="index-td text-[0.65rem] w-20"></td>
                            <td class="index-td text-[0.65rem] w-20"></td>
                            <td class="index-td text-[0.65rem] w-28"></td>
                            <td class="index-td text-[0.65rem] w-24"></td>
                            <td class="index-td text-[0.65rem] w-24">
                                {{ date('d-M-Y', strtotime($sale->created_at)) }}</td>
                            <td class="index-td text-[0.65rem] w-28">{{ $sale->user->name }}</td>
                            <td class="index-td text-[0.65rem] w-12">
