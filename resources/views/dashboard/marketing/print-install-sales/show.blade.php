    ...
    <div class="flex justify-center bg-black h-max">
        <div class="mt-10">
            ...
            <div>
                ...
                $products = json_decode($print_install_sale->products);
                        ...
                        <div class="body-detail">
                            <div class="sale-detail">
                                <div class="div-sale">
                                    ...
                                    <label class="label-sale-02">{{ $print_install_sale->number }}</label>
                                </div>
                                <div class="div-sale">
                                    <label class="label-sale-01">Tgl. Penjualan</label>
                                    <label class="label-sale-02">:</label>
                                    <label class="label-sale-02">{{ date('j', strtotime($print_install_sale->created_at)) }}
                                        {{ $month[(int) date('m', strtotime($print_install_sale->created_at))] }}
                                        {{ date('Y', strtotime($print_install_sale->created_at)) }}</label>
                                </div>
                                <div class="div-sale">
                                ...
                                <div class="div-sale">
                                    ...
                                    <label class="label-sale-02">:</label>
                                    <label id="orderDocuments" class="label-sale-02 ml-2">{{ count($print_install_orders) }}
                                        documents</label>
                                </div>
                            </div>
                            <div class="sale-detail ml-4">
                                <div class="div-sale">
                                    ...
                                    <label class="label-sale-02">:</label>
                                    <label
                                        class="label-sale-02">{{ $print_install_sale->print_instal_quotation->number }}</label>
                                </div>
                                <div class="div-sale">
                                    <label class="label-sale-01">Tgl. Penawaran</label>
                                    <label class="label-sale-02">:</label>
                                    <label class="label-sale-02">
                                        {{ date('j', strtotime($print_install_sale->print_instal_quotation->created_at)) }}
                                        {{ $month[(int) date('m', strtotime($print_install_sale->print_instal_quotation->created_at))] }}
                                        {{ date('Y', strtotime($print_install_sale->print_instal_quotation->created_at)) }}
                                    </label>
                                </div>
                                <div class="div-sale">
                                    <label class="label-sale-01">Nama Klien</label>
                                    <label class="label-sale-02">:</label>
                                    <label class="label-sale-02">{{ $print_install_sale->client->name }}</label>
                                </div>
                                <div class="div-sale">
                                    <label class="label-sale-01">Perusahaan</label>
                                    <label class="label-sale-02">:</label>
                                    <label class="label-sale-02">{{ $print_install_sale->client->company }}</label>
                                </div>
                                <div class="div-sale">
                                    <label class="label-sale-01">Alamat</label>
                                    <label class="label-sale-02">:</label>
                                    <textarea class="label-sale-02 w-60 outline-none" rows="2" readonly>{{ $print_install_sale->client->address }}</textarea>
                                </div>
                                <div class="div-sale">
                                    <label class="label-sale-01">Kontak Person</label>
                                    <label class="label-sale-02">:</label>
                                    <label class="label-sale-02">{{ $print_install_sale->contact->name }}</label>
                                </div>
                                <div class="div-sale">
                                    <label class="label-sale-01">No. Hp</label>
                                    <label class="label-sale-02">:</label>
                                    <label class="label-sale-02">{{ $print_install_sale->contact->phone }}</label>
                                </div>
                                <div class="div-sale">
                                    <label class="label-sale-01">Email</label>
                                    <label class="label-sale-02">:</label>
                                    <label class="label-sale-02">{{ $print_install_sale->contact->email }}</label>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tbody id="billboardsPreviewTBody">
                                            <tr>
                                                ...
                                                @if ($products->print == true)
                                                    ...
                                                    <td class="text-xs text-teal-700 border text-center" rowspan="2">
                                                        {{ $products->wide }}</td>
                        ...
                        <div class="body-bottom-sale mt-2">
                            <div class="sale-detail">
                                @foreach ($billboard_photos as $photo)
                                    @if ($photo->billboard_id == $print_install_sale->billboard->id)
                ...
                <input type="text" id="saveNumber"
                    value="{{ Str::substr($print_install_sale->number, 0, 4) . '_PJ Cetak & Pasang_' . $print_install_sale->client->name . '_' . $products->billboard_code }}"
                    hidden>
            </div>
            <div class="mb-10">
            </div>
