    ...
    <div class="mt-10 z-0">
        <div class="flex justify-center w-full">
            <div class="w-[1200px] p-2">
                <div class="flex">
                    <h1 class="index-h1"> Daftar Surat Penawaran Videotron</h1>
                    <div class="flex border-b">
                        <a href="/dashboard/marketing/videotron-quotations/create" class="index-link btn-primary">
                ...
                <form class="flex mt-2" action="/dashboard/marketing/videotron-quotations/">
                    <div class="flex">
        ...
        <div class="flex justify-center w-full">
            <div class="w-[1200px]">
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        @foreach ($videotron_quotations as $videotron_quotation)
                            <tr>
                                <td class="text-teal-700 border text-sm text-center">{{ $loop->iteration }}</td>
                                <td class="text-teal-700 border text-sm text-center">{{ $videotron_quotation->number }}</td>
                                ...
                                <td class="text-teal-700 border text-sm text-center align-center">
                                    <div class="flex justify-center">
                                        <a href="/dashboard/marketing/videotron-quotations/{{ $videotron_quotation->id }}"
