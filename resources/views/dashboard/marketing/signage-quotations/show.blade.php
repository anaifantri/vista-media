                        ...
                        <div class="mt-1">
                            <div class="mt-1 w-80 h-max border rounded-md py-1 px-2">
                                ...
                                <div class="overflow-y-auto h-[350px]">
                                    @foreach ($signage_quotation->signage_quot_statuses as $quotStatus)
                                        @if ($quotStatus->signage_quot_revision_id == null)
                                            <?php
                                ...
                                @if (count($signage_quotation->signage_quot_revisions) != 0)
                                    <div class="mt-1">
                                        <label class="text-sm text-teal-900 border-b font-semibold">Daftar Revisi</label>
                                        <div class="overflow-y-auto h-16">
                                            @foreach ($signage_quotation->signage_quot_revisions as $signage_quot_revision)
                                                <a class="flex"
                                                    href="/dashboard/marketing/signage-quot-revisions/{{ $signage_quot_revision->id }}">
                                                    <span
                                                        class="text-teal-900 hover:text-emerald-500 text-sm">{{ $loop->iteration }}.
                                                        {{ $signage_quot_revision->number }}</span>
                                                </a>
                                            @endforeach
                                        </div>
                                    </div>
                        ...
                        <form class="" action="/dashboard/marketing/signage-quot-statuses" method="post"
                            ...
                            @if (
                                $last_quot_statuses->status == 'Deal' ||
                                    ...
                                    count($signage_quotation->signage_quot_revisions) != 0)
                        ...
                        <div class="flex justify-start mt-5">
                            ...
                            @if ($last_quot_statuses->status != 'Deal' && $last_quot_statuses->status != 'Closed')
                                <a class="flex justify-center items-center ml-1 xl:mx-2 2xl:h-10 btn-warning"
                                    href="/dashboard/marketing/signage-quot-revisions/revision/{{ $signage_quotation->id }}">
                                ...
                                <div class="flex justify-center">
                                    <div class="w-[725px] mt-2">
                                        <div class="flex">
                                            ...
                                            <label
                                                class="ml-1 text-sm text-black">{{ $signage_quotation->number }}</label>
                                        </div>
                                        <div class="flex">
