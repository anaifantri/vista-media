...
@section('container')
    <div class="flex justify-center mt-10">
        <form class="md:flex" method="post" action="/dashboard/marketing/sale-categories/{{ $sale_category->id }}"
            ...
            <div class="flex w-[300px] justify-center items-center">
                <div class="p-3 w-full">
                    <div class="flex items-center justify-center mb-2 border-b w-full">
                        <h4 class="text-xl font-semibold tracking-wider text-teal-900">Edit Katagori Penjualan</h4>
                    </div>
                        ...
                        <div>
                            <div class="mt-1">
                                ...
                                <input
                                    ...
                                    value="{{ $sale_category->name }}" autofocus required>
                                @error('name')
                            ...
                            <div class="mt-1">
                                ...
                                <textarea
                                    ...
                                    name="description" id="description" placeholder="Input deskripsi bahan">{{ $sale_category->description }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
