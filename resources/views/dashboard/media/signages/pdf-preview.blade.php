...
@section('container')
    ...
    <div class="flex justify-center bg-black">
        <input id="code" type="text" value="{{ $signage->code }}" hidden>
        <input id="city" type="text" value="{{ $signage->city->city }}" hidden>
        <input id="address" type="text" value="{{ $signage->address }}" hidden>
        <div class="mt-10">
            <!-- Title Show sigange start -->
                ...
                <div id="pdfPreview" name="pdfPreview" class="ml-2 w-[780px] h-[1100px] bg-white mt-2">
                    ...
                    <div class="flex w-full h-[44px] justify-center items-center mt-1">
                        <div class="flex w-[700px] h-[44px] justify-start items-center bg-slate-50 border rounded-t-xl">
                            ...
                            <span
                                class="flex items-center w-[575px] h-[36px] text-base font-semibold">{{ $signage->address }}
                            ...
                            <div class="flex w-[476px] h-[385px] bg-white justify-center">
                                ...
                                <div class="">
                                    ...
                                    <div class="flex relative w-[476px] h-[355px] mt-[1px] rounded-b-lg">
                                        {{-- <?php
                                        $src = 'https://maps.googleapis.com/maps/api/staticmap?center=' . $signage->lat . ',' . $signage->lng . '&zoom=17&size=480x355&maptype=terrain&markers=icon:https://vistamedia.co.id/img/marker-red.png%7C' . $signage->lat . ',' . $signage->lng . '&key=AIzaSyCZT6TYRimJY8YoPn0cABAdGnbVLGVusWg';
                                        ?> --}}
                            ...
                            <div class="flex w-[220px] h-[385px] bg-white justify-center ml-1">
                                <div class="">
                                    ...
                                    <div class="w-[220px] h-[92px] bg-slate-50 mt-[1px] rounded-b-lg border">
                                        ...
                                        <div class="flex mt-1">
                                            <span
                                                class="w-[80px] text-xs font-sans font-bold tracking-wide text-teal-900 ml-2">Katagori</span>
                                            <span
                                                class="w-[140px] text-xs font-sans font-bold tracking-wide text-teal-900">:
