                                ...
                                <div id="slotQty" name="slotQty" class="mt-1" hidden>
                                    ...
                                    <div class="mt-1">
                                        <input
                                            ...
                                            type="text" id="slots" name="slots" value="{{ $signage->slots }}"
                                ...
                                <div id="duration" name="duration" class="mt-1" hidden>
                                    ...
                                    <div class="mt-1">
                                        <select id="duration" name="duration"
                                            ...
                                            type="text" value="{{ $signage->duration }}">
                                            @for ($numberDuration = 0; $numberDuration < count($durations); $numberDuration++)
                                                @if ($signage->duration == $durations[$numberDuration])
                            ...
                            <div class="mt-1">
                                ...
                                <div class="mt-1">
                                    <select id="side" name="side"
                                        ...
                                        type="text" value="{{ $signage->side }}">
                                        @for ($numberSide = 0; $numberSide < count($sides); $numberSide++)
                                            @if ($signage->side == $sides[$numberSide])
                            ...
                            <div class="mt-1">
                                ...
                                <div class="mt-1">
                                    <select id="orientation" name="orientation"
                                        ...
                                        type="text" value="{{ $signage->orientation }}">
                                        @for ($numberOrientation = 0; $numberOrientation < count($orientations); $numberOrientation++)
                                            @if ($signage->orientation == $orientations[$numberOrientation])
                            ...
                            <div class="flex mt-1">
                                ...
                                <div class="mt-1">
                                    ...
                                    <select id="condition" name="condition"
                                        ...
                                        type="text" value="{{ $signage->condition }}">
                                        @for ($numberBuild = 0; $numberBuild < count($builds); $numberBuild++)
                                            @if ($signage->condition == $builds[$numberBuild])
                    ...
                    <div>
                        ...
                        <div class="mt-4 md:mt-0 md:ml-2 xl:ml-4">
                            ...
                            @foreach ($signage_photos as $photo)
                                @if ($photo->signage_code == $signage->code && $photo->company_id == '1')
                                    <div
