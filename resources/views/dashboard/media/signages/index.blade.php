                    ...
                    <div class="flex mt-1 ml-2">
                        ...
                        <div class="w-full md:w-36 ml-2">
                            ...
                            <select class="w-full border rounded-lg text-base text-teal-900 outline-none" name="condition"
                                ...
                                <?php $dataCondition = ['All', 'Terbangun', 'Pembangunan', 'Rencana']; ?>
                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr class="index-tr items-center h-10 bg-teal-100 border-t">
                            ...
                            <th class="index-td text-sm w-24 2xl:w-28">Katagori</th>
                            <th class="index-td text-sm w-[88px] 2xl:w-24">Size - V/H</th>
                            <th class="index-td text-sm w-12 2xl:w-16">Jumlah</th>
                            <th class="index-td text-sm w-[100px] 2xl:w-28">Kondisi</th>
                            <th class="index-td text-sm w-36">@sortablelink('exclusive_price', 'Harga Eksklusif')
                                <svg class="fill-current w-3 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z" />
                                </svg>
                            </th>
                            <th class="index-td text-sm w-36">@sortablelink('sharing_price', 'Harga Sharing')
                                <svg class="fill-current w-3 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z" />
                                </svg>
                            </th>
                            <th class="index-td text-sm w-36">@sortablelink('price', 'Harga')
                                <svg class="fill-current w-3 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z" />
                                </svg>
                            </th>
