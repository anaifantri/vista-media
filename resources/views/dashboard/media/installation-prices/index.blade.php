...
@section('container')
    <!-- Container Index Installation Prices start -->
    <div class="mt-10 z-0">
        <div class="flex justify-center w-full">
            <div class="w-[800px] p-2">
                <div class="flex">
                    <!-- Title Installation Prices start -->
                    <h1 class="index-h1"> DAFTAR HARGA PASANG</h1>
                    <!-- Title Installation Prices end -->
                    <!-- Button Create New Installation Prices start -->
                    @canany(['isAdmin', 'isMedia'])
                        <div class="flex border-b">
                            <a href="/dashboard/media/installation-prices/create" class="index-link btn-primary"><span></span>
                ...
                <form class="mt-2" action="/dashboard/media/installation-prices/">
                    <div class="flex">
        ...
        <!-- Alert Success Create New Installation Price end -->
        <!-- View Installation Prices start -->
        <div class="flex justify-center w-full">
            <div class="w-[800px]">
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        @php
                            $number = 1 + ($installation_prices->currentPage() - 1) * $installation_prices->perPage();
                        @endphp
                        @foreach ($installation_prices as $installation_price)
                            <tr>
                                ...
                                <td class="px-2 text-teal-700 border text-xs text-center">
                                    {{ date('d-M-Y', strtotime($installation_price->created_at)) }}
                                </td>
                                <td class="text-teal-700 border text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        <a href="/dashboard/media/installation-prices/{{ $installation_price->id }}"
    ...
    <!-- View Installation Prices end -->
    <!-- Container Index Installation Prices end -->
@endsection
