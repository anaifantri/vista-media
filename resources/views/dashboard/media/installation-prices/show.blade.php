...
@section('container')
    <div class="flex justify-center mt-10">
        <div class="md:flex">
            <div class="flex justify-center w-[315px] items-center">
                    ...
                    <div class="flex justify-center mt-5 w-full">
                        <div>
                            ...
                            <div class="border-b mt-2"><label class="text-sm text-teal-700">Nama</label>
                                <h6 class="text-base font-semibold text-teal-900">{{ $installation_price->name }}</h6>
                            </div>
                            <div class="border-b mt-2"><label class="text-sm text-teal-700">Tipe</label>
                                <h6 class="text-base font-semibold text-teal-900">
                                    {{ $installation_price->printing_price }}</h6>
                            </div>
                            <div class="border-b mt-2"><label class="text-sm text-teal-700">Harga</label>
                                <h6 class="text-base font-semibold text-teal-900">
                                    {{ number_format($installation_price->price) }}</h6>
                            </div>
                            <div class="border-b mt-2"><label class="text-sm text-teal-700">Tanggal Dibuat</label>
                                <h6 class="text-base font-semibold text-teal-900">
                                    {{ $installation_price->created_at->format('l, d-M-Y') }}
                                </h6>
                            </div>
                            <div class="border-b mt-2"><label class="text-sm text-teal-700">Tanggal Perubahan
                                    Terakhir</label>
                                <h6 class="text-base font-semibold text-teal-900">
                                    {{ $installation_price->updated_at->format('l, d-M-Y') }}
                                </h6>
                            </div>
                            ...
                            <div class="flex mt-2">
                                ...
                                <a href="/dashboard/media/installation-prices/{{ $installation_price->id }}/edit"
                                ...
                                <form action="/dashboard/media/installation-prices/{{ $installation_price->id }}"
                                    method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="flex items-center justify-center btn-danger mx-1"
                                        onclick="return confirm('Apakah anda yakin ingin menghapus harga pasang dengan nama {{ $installation_price->name }} tipe {{ $installation_price->type }} ?')">
                                        <svg class="fill-current w-5" clip-rule="evenodd" fill-rule="evenodd"
                                            stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
