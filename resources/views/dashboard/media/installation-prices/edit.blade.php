...
@section('container')
    <div class="flex justify-center mt-10">
        <form class="md:flex" method="post" action="/dashboard/media/installation-prices/{{ $installation_price->id }}"
                        ...
                        <div>
                            <div class="mt-1">
                                ...
                                <input
                                    ...
                                    value="{{ $installation_price->name }}" required>
                                @error('name')
                                ...
                                <div class="mt-1">
                                    <select id="type" name="type"
                                        ...
                                        @for ($numbertype = 0; $numbertype < count($types); $numbertype++)
                                            @if ($installation_price->type == $types[$numbertype])
                            ...
                            <div class="mt-1">
                                ...
                                <input
                                    ...
                                    value="{{ $installation_price->price }}" required>
                                @error('price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
