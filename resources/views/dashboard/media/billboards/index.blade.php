                    ...
                    <div class="flex mt-1 ml-2">
                        ...
                        <div class="w-full md:w-36 ml-2">
                            ...
                            <select class="w-full border rounded-lg text-base text-teal-900 outline-none" name="condition"
                                ...
                                <?php $condition = ['All', 'Terbangun', 'Rencana', 'Tidak Ada']; ?>
                                @for ($i = 0; $i < count($condition); $i++)
                                    @if (request('condition') == $condition[$i])
                                        <option value="{{ $condition[$i] }}" selected> <?php echo $condition[$i]; ?> </option>
                                    @else
                                        <option value="{{ $condition[$i] }}"> <?php echo $condition[$i]; ?> </option>
                                    @endif
                                @endfor
                            </select>
                        </div>
                    ...
                    <thead>
                        <tr class="bg-teal-100 h-10">
                            ...
                            {{-- <th class="text-teal-700 border text-sm text-center w-32">
                                <button class="flex justify-center items-center w-32">@sortablelink('price', 'Harga (Rp.)')
                                    <svg class="fill-current w-3 ml-1" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z" />
                                    </svg>
                        ...
                        @foreach ($billboards as $billboard)
                            @if ($number % 2 != 0)
                                <tr>
                                    ...
                                    <td class="text-teal-700 border text-sm text-center">{{ $billboard->code }} -
                                        {{ $billboard->city->code }}
                                    </td>
                                    <td class="text-teal-700 border text-sm">
                                        {{ $billboard->address }}
                                    </td>
                                    <td class="text-teal-700 border text-sm text-center">{{ $billboard->area->area }}</td>
                                    <td class="text-teal-700 border text-sm text-center">{{ $billboard->city->city }}</td>
                                    ...
                                    @if ($billboard->size != '')
                                        <td class="text-teal-700 border text-sm text-center">{{ $billboard->size->size }}
                                            -
                                    ...
                                    @endif
                                    <td class="text-teal-700 border text-sm text-center">{{ $billboard->condition }}
                                    </td>
                                    {{-- @if ($billboard->price)
                                        <td class="text-teal-700 border text-sm text-center">
                                            {{ number_format($billboard->price) }}</td>
                                    @else
                                        <td class="text-teal-700 border">-</td>
                                    @endif --}}
                                    ...
                                    <td class="text-teal-700 border text-sm text-center">
                                        <div class="flex justify-center items-center">
                                            ...
                                            @canany(['isAdmin', 'isMedia', 'isMarketing'])
                                                ...
                                                <form action="/dashboard/media/billboards/{{ $billboard->id }}"
