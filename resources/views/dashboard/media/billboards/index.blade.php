        ...
        <div class="index-table">
            <form action="/dashboard/media/billboards/">
                <div class="w-40 flex absolute">
                    ...
                    <select class="w-40 border rounded-lg flex absolute mt-6 text-base text-teal-900 outline-none"
                ...
                <div class="w-40 flex absolute ml-44">
                ...
                <div class="w-40 flex absolute ml-[352px]">
                    <span class="w-32 flex absolute text-base text-teal-900">Kondisi</span>
                    <select class="w-40 border rounded-lg flex absolute mt-6 text-base text-teal-900 outline-none"
                        name="build" id="build" onchange="submit()">
                ...
                <div class="w-40 flex absolute ml-[528px]">
                    <span class="w-32 flex absolute text-base text-teal-900">Status</span>
                    <select class="w-40 border rounded-lg flex absolute mt-6 text-base text-teal-900 outline-none"
                        name="sale" id="sale" onchange="submit()">
