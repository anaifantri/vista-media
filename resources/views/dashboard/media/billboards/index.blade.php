                                ...
                                @if ($product->category == 'Billboard')
                                    @if ($number % 2 != 0)
                                        <tr class="index-tr items-start h-max">
                                            ...
                                            @endif
                                            <td class="index-td text-sm w-[104px] 2xl:w-28">{{ $product->build_status }}
                                            </td>
                                            <td class="flex items-start justify-center text-sm w-16">
                                                {{ $product->sale_status }}
                                            </td>
                                            @if ($product->client)
                                                <td class="index-td text-sm w-[104px] 2xl:w-28">{{ $product->client }}
                                                </td>
                                            @else
                                            ...
                                            <td class="index-td text-sm w-[110px] 2xl:w-36">
                                                ...
                                                @canany(['isAdmin', 'isMedia', 'isMarketing'])
                                                    ...
                                                    <form action="/dashboard/media/products/{{ $product->id }}"
