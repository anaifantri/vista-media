...
@section('container')
    <div class="flex justify-center mt-10">
        <form class="md:flex" method="post" action="/dashboard/media/sizes/{{ $size->id }}" enctype="multipart/form-data">
            @method('put')
            @csrf
                    ...
                    <div class="mt-5 w-full">
                        <div class="mt-2"><label class="text-sm text-teal-700">Ukuran</label>
                            <input
                                ...
                                value="{{ $size->size }}" autofocus required>
                            @error('size')
                        ...
                        <div class="mt-2"><label class="text-sm text-teal-700">Jumlah Sisi</label>
                            ...
                            <select
                                ...
                                name="side" id="side" value="{{ $size->side }}" required>
                        ...
                        <div class="mt-2"><label class="text-sm text-teal-700">Orientasi</label>
                            ...
                            <select
                                ...
                                name="orientation" id="orientation" value="{{ $size->orientation }}" required>
                                @for ($number = 0; $number < count($orientations); $number++)
                                    @if ($size->orientation == $orientations[$number])
