                    ...
                    <thead>
                        <tr class="bg-teal-100 h-10">
                            ...
                            <th class="text-teal-700 border text-sm text-center w-24">
                                <button class="flex justify-center items-center w-24">@sortablelink('size', 'Ukuran')
                            ...
                            <th class="text-teal-700 border text-sm text-center">Dibuat Oleh</th>
                            <th class="text-teal-700 border text-sm text-center">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
                        ...
                        @foreach ($sizes as $size)
                            <tr>
                                ...
                                <td class="text-teal-700 border text-sm text-center">{{ $size->category }}</td>
                                <td class="text-teal-700 border text-sm text-center">{{ $size->user->name }}</td>
