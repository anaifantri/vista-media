...
@section('container')
    <div class="flex justify-center mt-10">
        <div class="md:flex">
            <div class="flex w-[315px] items-center">
                <div class="p-3 py-5 w-full">
                    ...
                    <div class="mt-5 w-full">
                        ...
                        <div class="border-b mt-2"><label class="text-sm text-teal-700">Tanggal Perubahan
                                Terakhir</label>
                            <h6 class="text-base font-semibold text-teal-900">
                                {{ $size->updated_at->format('l, d-M-Y') }}
                            </h6>
                        </div>
                        @if ($size->created_at != $size->updated_at)
                        ...
                        @endif
                        <div class="flex mt-2">
                            <a href="/dashboard/media/sizes" class="flex items-center justify-center btn-primary mx-1">
                            ...
                            <form action="/dashboard/media/sizes/{{ $size->id }}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
