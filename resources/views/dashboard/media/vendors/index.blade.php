            ...
            <table class="table-auto w-full lg:w-[800px] mb-6">
                <thead>
                    <tr class="index-tr items-center h-10 bg-teal-100 border-t">
                        ...
                        <th class="index-td text-sm w-24">Katagori</th>
                ...
                <tbody>
                    @foreach ($vendors as $vendor)
                        <tr class="index-tr">
                            ...
                            <td class="index-td text-sm w-36">{{ $vendor->name }}</td>
                            <td class="index-td text-sm w-48">{{ $vendor->company }}</td>
                            <td class="index-td text-sm w-24">{{ $vendor->vendor_category->name }}</td>
                            @if ($vendor->email)
                                <td class="index-td text-sm w-44">{{ $vendor->email }}</td>
                            @else
                                <td class="index-td text-sm w-44">-</td>
                            @endif
                            <td class="index-td text-sm w-32">{{ $vendor->phone }}</td>
