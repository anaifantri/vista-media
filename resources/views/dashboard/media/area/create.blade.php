        ...
        <div class="items-center mt-10 w-80 ml-0">
            ...
            <form action="/dashboard/media/area" method="post">
                ...
                <div class="flex mx-5 mt-3
                    ...
                    <select id="provinsi" name="provinsi" class="ml-3 p-1 rounded-sm w-[298px] h-8 outline-none"
                        type="text" autofocus>
                    </select>
                </div>
                <div class="flex mx-5 mt-3">
                ...
                <div class="flex mx-5 mt-5">
                    <button
                        class="flex justify-center w-28 h-8 hover:bg-emerald-500 rounded-md bg-emerald-400 items-center text-white drop-shadow-lg"
                        type="submit">
                    ...
                    <a class="flex justify-center ml-3 w-28 h-8 hover:bg-red-600 rounded-md bg-red-500 items-center text-white drop-shadow-lg"
