...
@section('container')
    <div class="flex justify-center mt-10">
        <form class="md:flex" method="post" action="/dashboard/media/billboard-categories" enctype="multipart/form-data">
            @csrf
            <div class="flex w-[300px] justify-center items-center">
                <div class="p-3 w-full">
                    <div class="flex items-center justify-center mb-2 border-b w-full">
                        <h4 class="text-xl font-semibold tracking-wider text-teal-900">Tambah Katagori Billboard</h4>
                    </div>
