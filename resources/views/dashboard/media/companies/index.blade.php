            ...
            <div class="w-[1200px] p-2">
                <div class="flex">
                    ...
                    <div class="flex border-b">
                        <a href="/dashboard/media/companies/create" class="index-link btn-primary">
                ...
                <form class="flex mt-2" action="/dashboard/media/companies/">
                    <div class="flex">
                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr class="bg-teal-100 h-10">
                            ...
                            <th class="text-teal-700 border text-sm text-center w-14">
                    ...
                    <tbody>
                        ...
                        @foreach ($companies as $company)
                            <tr>
                                ...
                                <td class="text-teal-700 p-1 border text-sm text-center">{{ $company->code }}</td>
                                <td class="text-teal-700 p-1 border text-sm text-center">{{ $company->name }}</td>
                                <td class="text-teal-700 p-1 border text-sm">{{ $company->address }}</td>
                                @if ($company->email)
                                    <td class="text-teal-700 p-1 border text-sm text-center">{{ $company->email }}</td>
                                @else
                                ...
                                <td class="text-teal-700 p-1 border text-sm text-center">
                                    <div class="flex justify-center items-center">
                                        <a href="/dashboard/media/companies/{{ $company->id }}"
                                        ...
                                        <form action="/dashboard/media/companies/{{ $company->id }}" method="post"
                                            class="d-inline m-1">
                                            @method('delete')
                                            @csrf
                                            <button
