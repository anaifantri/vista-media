...
@section('container')
    <div class="flex justify-center mt-10">
        <form class="md:flex" method="post" action="/dashboard/media/printing-products/{{ $printing_product->id }}"
            ...
            <div class="flex w-[300px] justify-center items-center">
                <div class="p-3 w-full">
                    <div class="flex items-center justify-center mb-2 border-b w-full">
                        <h4 class="text-xl font-semibold tracking-wider text-teal-900">Edit Bahan Cetak</h4>
                    </div>
                    <div class="flex justify-center mt-5 w-full">
                        <div>
                                ...
                                <div class="mt-1">
                                    <select id="type" name="type"
                                        ...
                                        @for ($numbertype = 0; $numbertype < count($types); $numbertype++)
                                            @if ($printing_product->type == $types[$numbertype])
                            ...
                            <div class="mt-1">
                                ...
                                <input
                                    class="text-sm font-semibold p-1 text-teal-900 border rounded-md outline-none w-[250px] @error('price') is-invalid @enderror"
