                        ...
                        <div>
                            ...
                            <div class="border-b mt-2"><label class="text-sm text-teal-700">Tanggal Dibuat</label>
                                <h6 class="text-base font-semibold text-teal-900">
                                    {{ $printing_product->created_at->format('l, d-M-Y') }}
                                </h6>
                            </div>
                            <div class="border-b mt-2"><label class="text-sm text-teal-700">Tanggal Perubahan
                                    Terakhir</label>
                                <h6 class="text-base font-semibold text-teal-900">
                                    {{ $printing_product->updated_at->format('l, d-M-Y') }}
                                </h6>
                            </div>
                            ...
                            @endif
                            <div class="flex mt-2">
                                <a href="/dashboard/media/printing-products"
                                ...
                                <form action="/dashboard/media/printing-products/{{ $printing_product->id }}" method="post"
                                    class="d-inline">
                                    @method('delete')
                                    @csrf
