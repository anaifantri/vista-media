    ...
    <div class="mt-10 z-0">
        <div class="flex justify-center w-full">
            <div class="w-[800px] p-2">
                <div class="flex">
                    ...
                    @canany(['isAdmin', 'isMedia'])
                        <div class="flex border-b">
                            <a href="/dashboard/media/printing-products/create" class="index-link btn-primary"><span></span>
                ...
                <form class="mt-2" action="/dashboard/media/printing-products/">
                    <div class="flex">
                            ...
                            <tr>
                                ...
                                <td class="text-teal-700 border text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        <a href="/dashboard/media/printing-products/{{ $printing_product->id }}"
                                        ...
                                        <a href="/dashboard/media/printing-products/{{ $printing_product->id }}/edit"
                                        ...
                                        @can('isAdmin')
                                            <form action="/dashboard/media/printing-products/{{ $printing_product->id }}"
