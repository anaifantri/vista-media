...
@section('container')
    ...
    <div class="flex justify-center mt-10">
        <div class="flex w-96 -ml-[660px] absolute border-b p-2">
            <h1 class="flex text-xl text-cyan-800 font-bold tracking-wider"> MENAMBAHKAN Videotron</h1>
        </div>
        <!-- Title Create New Videotron end -->
        <!-- Form Create New Videotron start -->
        <form action="/dashboard/media/videotrons" method="post" enctype="multipart/form-data">
            @csrf
