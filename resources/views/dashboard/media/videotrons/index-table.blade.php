                ...
                <table class="table-auto mt-14">
                    <thead>
                        <tr class="index-tr items-center h-10 bg-slate-50 border-t">
                            ...
                            <th class="index-td text-sm w-20">Pixel</th>
                            <th class="index-td text-sm w-20">Vendor LED</th>
                            ...
                            <th class="index-td text-sm w-24">Awal Kontak</th>
                            <th class="index-td text-sm w-24">Akhir Kontrak</th>
                            <th class="index-td text-sm w-28">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($products as $product)
                            @if ($product->category == 'Videotron')
                                <tr class="index-tr items-start h-max">
                                    ...
                                    <td class="index-td text-sm w-20">{{ $product->led_id }}</td>
                                    <td class="index-td text-sm w-20">{{ $product->vendor_id }}</td>
                                    @if ($product->size != '')
                                    ...
                                    @if ($product->client)
                                        <td class="flex text-sm w-28">
                                            <div>
                                                <div>1. {{ $product->client }} </div>
                                                <div>2. {{ $product->client }}</div>
                                                <div>3. {{ $product->client }} </div>
                                                <div>4. {{ $product->client }}</div>
                                                <div>5. {{ $product->client }}</div>
                                            </div>
                                        </td>
                                    @else
                                    ...
                                    @if ($product->price)
                                        <td class="flex items-center justify-end text-sm w-24">
                                            <div>
                                                <div>1. {{ number_format($product->price) }} </div>
                                                <div>2. {{ number_format($product->price) }}</div>
                                                <div>3. {{ number_format($product->price) }} </div>
                                                <div>4. {{ number_format($product->price) }}</div>
                                                <div>5. {{ number_format($product->price) }}</div>
                                            </div>
                                        </td>
                                    @else
                                        <td class="index-td text-sm w-24">-</td>
