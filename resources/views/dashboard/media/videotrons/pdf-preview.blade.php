...
@section('container')
    ...
    <div class="flex justify-center bg-black">
        <input id="code" type="text" value="{{ $videotron->code }}" hidden>
        <input id="city" type="text" value="{{ $videotron->city->city }}" hidden>
        <input id="address" type="text" value="{{ $videotron->address }}" hidden>
        <div class="mt-10">
                                ...
                                <div class="">
                                    ...
                                    <div class="w-[220px] h-[92px] bg-slate-50 mt-[1px] rounded-b-lg border">
                                        ...
                                        <div class="flex mt-1">
                                            ...
                                            <span
                                                class="w-[140px] text-xs font-sans font-bold tracking-wide text-teal-900">:
                                                {{ $videotron->led->pixel_pitch }} </span>
                                        </div>
                                    </div>
                                    <div
