                            ...
                            <select class="w-full border rounded-lg text-base text-teal-900 outline-none" name="sale"
                                ...
                                @for ($i = 0; $i < count($dataSale); $i++)
                                    @if (request('sale') == $dataSale[$i])
                                        <option value="{{ $dataSale[$i] }}" selected> <?php // echo $dataSale[$i];
                                        ?> </option>
                                    @else
                                        <option value="{{ $dataSale[$i] }}"> <?php // echo $dataSale[$i];
                                        ?> </option>
                                    @endif
                                @endfor
                            </select>
                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr class="index-tr items-center h-10 bg-teal-100 border-t">
                            ...
                            <th class="index-td text-sm w-44">@sortablelink('sharing_price', 'Harga Sharing')
                                <svg class="fill-current w-3 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z" />
                                </svg>
                            </th>
                        ...
                        @foreach ($videotrons as $videotron)
                            @if ($number % 2 != 0)
                                <tr class="index-tr items-start h-max">
                                    ...
                                    <td class="index-td text-sm w-[84px] 2xl:w-32">{{ $videotron->code }} -
                                        {{ $videotron->city->code }}
                                    </td>
                                    <td class="flex justify-start items-center text-sm w-56 2xl:w-80">
                                        {{ $videotron->address }}
                                    </td>
                                    <td class="index-td text-sm w-12 2xl:w-16">{{ $videotron->city->code }}</td>
                                    <td class="index-td text-sm w-24 2xl:w-28">{{ $videotron->led->name }}</td>
                                    <td class="index-td text-sm w-[88px] 2xl:w-24">{{ $videotron->size->size }}
                                        -
                                    ...
                                    <td class="flex items-center justify-center text-sm w-44">Rp.
                                        {{ number_format($videotron->sharing_price) }},-</td>
