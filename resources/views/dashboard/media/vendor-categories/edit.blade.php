...
@section('container')
    <div class="flex justify-center mt-10">
        <form class="md:flex" method="post" action="/dashboard/media/vendor-categories/{{ $vendor_category->id }}"
                        ...
                        <div>
                            <div class="mt-1">
                                ...
                                <input
                                    ...
                                    value="{{ $vendor_category->name }}" autofocus required>
                                @error('name')
                            ...
                            <div class="mt-1">
                                ...
                                <textarea
                                    ...
                                    name="description" id="description" placeholder="Input deskripsi bahan">{{ $vendor_category->description }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
