                    ...
                    <div class="flex justify-center mt-3 w-full">
                        <div>
                            ...
                            <div class="mt-1">
                                ...
                                <textarea class="flex text-base font-semibold text-teal-900 w-[300px]  border rounded-lg p-1 outline-teal-300" readonly>{{ $vendor_category->description }}</textarea>
                            </div>
                            <div class="border-b mt-2"><label class="text-sm text-teal-700">Tanggal Dibuat</label>
                                <h6 class="text-base font-semibold text-teal-900">
                                    {{ $vendor_category->created_at->format('l, d-M-Y') }}
                                </h6>
                            </div>
                            <div class="border-b mt-2"><label class="text-sm text-teal-700">Tanggal Perubahan
                                    Terakhir</label>
                                <h6 class="text-base font-semibold text-teal-900">
                                    {{ $vendor_category->updated_at->format('l, d-M-Y') }}
                                </h6>
                            </div>
                            ...
                            @endif
                            <div class="flex mt-2">
                                <a href="/dashboard/media/vendor-categories"
