...
@section('container')
    ...
    <div class="mt-10 z-0">
        <div class="flex justify-center w-full">
            <div class="w-[800px] p-2">
                <div class="flex">
                    ...
                    @canany(['isAdmin', 'isMedia'])
                        <div class="flex border-b">
                            <a href="/dashboard/media/printing-prices/create" class="index-link btn-primary"><span></span>
                ...
                <form class="mt-2" action="/dashboard/media/printing-prices/">
                    <div class="flex">
                    ...
                    <tbody>
                        ...
                        @foreach ($printing_prices as $printing_price)
                            <tr>
                                ...
                                <td class="px-2 text-teal-700 border text-xs text-center">
                                    {{ date('d-M-Y', strtotime($printing_price->created_at)) }}
                                </td>
                                <td class="text-teal-700 border text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        <a href="/dashboard/media/printing-prices/{{ $printing_price->id }}"
                                        ...
                                        @can('isAdmin')
                                            <form action="/dashboard/media/printing-prices/{{ $printing_price->id }}"
    ...
    <!-- Container Index Printing Prices end -->
@endsection
