            ...
            <div class="flex justify-center w-[315px] items-center">
                <div class="p-3 w-full">
                    <div class="flex items-center mb-3 w-full border-b">
                        <h4 class="text-2xl font-semibold tracking-wider text-teal-900">Detail Harga Cetak</h4>
                    </div>
                    <div class="flex justify-center mt-5 w-full">
                        <div>
                            ...
                            <div class="flex mt-2">
                                ...
                                <a href="/dashboard/media/printing-prices/{{ $printing_price->id }}/edit"
                                ...
                                <form action="/dashboard/media/printing-prices/{{ $printing_price->id }}" method="post"
                                    class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="flex items-center justify-center btn-danger mx-1"
                                        onclick="return confirm('Apakah anda yakin ingin menghapus harga cetak dengan nama bahan {{ $printing_price->name }} ?')">
                                        <svg class="fill-current w-5" clip-rule="evenodd" fill-rule="evenodd"
                                            stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
