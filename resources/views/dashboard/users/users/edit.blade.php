...
@section('container')
    <div class="flex relative mt-5 items-center">
        <div class="flex">
            <form class="flex" method="post" action="/dashboard/users/{{ $user->id }}" enctype="multipart/form-data">
                @method('put')
                @csrf
    ...
    <script>
        ...
        const option = [];
        const arrayLevel = ['Administrator', 'Media', 'Marketing', 'Accounting', 'Workshop'];
