    ...
    <div class="flex">
        ...
        @if ($category == 'Videotron')
            <input
                ...
                name="slots" id="slots" type="number" min="1" max="5" value="{{ $description->slots }}"
                required>
        ...
        @else
            <input
                class="flex ml-2 text-semibold w-8 in-out-spin-none  border rounded-lg px-1 outline-none @error('slots') is-invalid @enderror"
                name="slots" id="slots" type="number" placeholder="0" min="1" max="5"
                value="{{ old('slots') }}">
        @endif
        ...
        @if ($category == 'Videotron')
            <input
                ...
                name="duration" id="duration" type="number" min="0" max="60"
                value="{{ $description->duration }}" required>
        @elseif ($category == 'Signage')
            @if ($description->type == 'Videotron')
                <input
                    class="flex ml-2 text-semibold w-10 in-out-spin-none  border rounded-lg px-1 outline-none @error('duration') is-invalid @enderror"
