                ...
                <ul class="block">
                    <div>
                        ...
                        <div class="nav-a mx-2">
                            ...
                            <li class="group hidden" id="liMedia" name="liMedia">
                        ...
                        <ul class="hidden" id="mediaChild" name="mediaChild">
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px] border-t-[1px] {{ Request::is('dashboard/media/billboards*') ? 'active' : '' }}"
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px] {{ Request::is('dashboard/media/videotrons*') ? 'active' : '' }}"
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px] {{ Request::is('dashboard/media/signages*') ? 'active' : '' }}"
                                    href="/dashboard/media/signages">
                                    <svg class="child-nav-svg rotate-90" xmlns="http://www.w3.org/2000/svg" role="img"
                                        viewBox="0 0 24 24">
                                        <path
                            ...
                            <span class="flex nav-a ml-[40px] border-t-[1px] border-b-[1px]"> Pengaturan </span>
                            <li class="group">
                                <a class="nav-a ml-[40px] {{ Request::is('dashboard/media/companies*') ? 'active' : '' }}"
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px] {{ Request::is('dashboard/media/area*') ? 'active' : '' }}"
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px] {{ Request::is('dashboard/media/cities*') ? 'active' : '' }}"
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/billboard-categories">
                                    <svg class="child-nav-svg" xmlns="http://www.w3.org/2000/svg" role="img"
                                        viewBox="0 0 24 24">
                                        <path
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/signage-categories">
                                    <svg class="child-nav-svg" xmlns="http://www.w3.org/2000/svg" role="img"
                                        viewBox="0 0 24 24">
                                        <path
                                            d="m20.998 8.498h-17.996c-.569 0-1.001.464-1.001.999 0 .118-.105-.582 1.694 10.659.077.486.496.842.988.842h14.635c.492 0 .911-.356.988-.842 1.801-11.25 1.693-10.54 1.693-10.66 0-.558-.456-.998-1.001-.998zm-.964-3.017h-16.03c-.524 0-1.001.422-1.001 1.007 0 .081-.01.016.14 1.01h17.752c.152-1.012.139-.931.139-1.009 0-.58-.469-1.008-1-1.008zm-15.973-1h15.916c.058-.436.055-.426.055-.482 0-.671-.575-1.001-1.001-1.001h-14.024c-.536 0-1.001.433-1.001 1 0 .056-.004.043.055.483z"
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/marketing/sale-categories">
                                    <svg class="child-nav-svg" xmlns="http://www.w3.org/2000/svg" role="img"
                                        viewBox="0 0 24 24">
                                        <path
                                            d="m20.998 8.498h-17.996c-.569 0-1.001.464-1.001.999 0 .118-.105-.582 1.694 10.659.077.486.496.842.988.842h14.635c.492 0 .911-.356.988-.842 1.801-11.25 1.693-10.54 1.693-10.66 0-.558-.456-.998-1.001-.998zm-.964-3.017h-16.03c-.524 0-1.001.422-1.001 1.007 0 .081-.01.016.14 1.01h17.752c.152-1.012.139-.931.139-1.009 0-.58-.469-1.008-1-1.008zm-15.973-1h15.916c.058-.436.055-.426.055-.482 0-.671-.575-1.001-1.001-1.001h-14.024c-.536 0-1.001.433-1.001 1 0 .056-.004.043.055.483z"
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/sizes">
                                    <svg class="child-nav-svg" xmlns="http://www.w3.org/2000/svg" role="img"
                                        viewBox="0 0 24 24">
                                        <path
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/leds">
                                    <svg class="child-nav-svg" xmlns="http://www.w3.org/2000/svg" role="img"
                                        viewBox="0 0 24 24">
                                        <path
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/printing-products">
                                    <svg class="child-nav-svg" xmlns="http://www.w3.org/2000/svg" role="img"
                                        viewBox="0 0 24 24">
                                        <path
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/printing-prices">
                                    <svg class="child-nav-svg" xmlns="http://www.w3.org/2000/svg" role="img"
                                        viewBox="0 0 24 24">
                                        <path
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/installation-prices">
                                    <svg class="child-nav-svg" xmlns="http://www.w3.org/2000/svg" role="img"
                                        viewBox="0 0 24 24">
                                        <path
                                            d="M7 16.462l1.526-.723c1.792-.81 2.851-.344 4.349.232 1.716.661 2.365.883 3.077 1.164 1.278.506.688 2.177-.592 1.838-.778-.206-2.812-.795-3.38-.931-.64-.154-.93.602-.323.818 1.106.393 2.663.79 3.494 1.007.831.218 1.295-.145 1.881-.611.906-.72 2.968-2.909 2.968-2.909.842-.799 1.991-.135 1.991.72 0 .23-.083.474-.276.707-2.328 2.793-3.06 3.642-4.568 5.226-.623.655-1.342.974-2.204.974-.442 0-.922-.084-1.443-.25-1.825-.581-4.172-1.313-6.5-1.6v-5.662zm-1 6.538h-4v-8h4v8zm15-11.497l-6.5 3.468v-7.215l6.5-3.345v7.092zm-7.5-3.771v7.216l-6.458-3.445v-7.133l6.458 3.362zm-3.408-5.589l6.526 3.398-2.596 1.336-6.451-3.359 2.521-1.375zm10.381 1.415l-2.766 1.423-6.558-3.415 2.872-1.566 6.452 3.558z" />
                            ...
                            <span class="flex nav-a ml-[40px] border-t-[1px] border-b-[1px]"> Legalitas OOH </span>
                            <li class="group">
                        ...
                        <ul class="hidden" id="marketingChild" name="marketingChild">
                            <!-- Client Start -->
                            <li class="group">
                                <a class="nav-a ml-[40px] border-t-[1px] {{ Request::is('/dashboard/marketing/clients*') ? 'active' : '' }}"
                            ...
                            <ul class="hidden" id="penawaranChild" name="penawaranChild">
                                ...
                                <li class="group">
                                    <a class="nav-a ml-[62px]" href="/dashboard/marketing/print-instal-quotations">
                                        <svg class="child-nav-svg" role="img" clip-rule="evenodd"
                                            fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li class="group">
                                    <a class="nav-a ml-[62px] border-b-[1px]" href="#">
                                        ...
                                        <span class="flex w-40"> Lap. Penawaran </span>
                                    </a>
                                </li>
                            </ul>
                            <!-- Child Penawaran End -->
                            ...
                            <ul class="hidden" id="penjualanChild" name="penjualanChild">
                                ...
                                <li class="group">
                                    <a class="nav-a ml-[62px] border-b-[1px]" href="/sales/reports/">
                                        ...
                                        <span class="flex w-40"> Lap. Penjualan </span>
                                    </a>
                                </li>
                            </ul>
                            <!-- Penjualan Child End -->
                            ...
                            <ul class="hidden" id="materiChild" name="materiChild">
                                ...
                                <li class="group">
                                    <a class="nav-a ml-[62px]" href="#">
                                        ...
                                        <span class="flex w-40"> Lap. Cetak </span>
                                    </a>
                                </li>
                                <li class="group">
                                    <a class="nav-a ml-[62px]" href="#">
                        ...
                        <div class="nav-a mx-2">
                            ...
                            <li id="liWorkshop" name="liWorkshop" class="group hidden">
                                <a href="#"
                        ...
                        <div class="nav-a mx-2">
                            ...
                            <li id="liUser" name="liUser" class="group hidden">
                                <a href="#"
                        ...
                        <ul id="userChild" name="userChild" class="hidden">
                            <li class="group">
                                <a class="nav-a ml-[40px] border-t-[1px] {{ Request::is('/dashboard/users/users*') ? 'active' : '' }}"
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px] {{ Request::is('/dashboard/users/notifications*') ? 'active' : '' }}"
