            ...
            <ul class="block">
                <div>
                    ...
                    <ul class="hidden" id="mediaChild" name="mediaChild">
                        @canany(['isAdmin', 'isMedia'])
                            <li class="group">
                                <a class="nav-a ml-[40px] border-t-[1px]" href="/dashboard/media/area">
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/billboards">
                                    <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24">
                                        <path
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="#">
                                    <svg class="nav-svg" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path
