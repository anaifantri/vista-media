        ...
        <nav>
            <ul class="block">
                <div>
                    ...
                    <li class="group">
                        <a href="#" class="nav-a mx-4 {{ Request::is('dashboard') ? 'active' : '' }}">
                    ...
                    <li class="group" id="media" name="media">
                        @canany(['isAdmin', 'isMedia'])
                            <a href="#" class="nav-a mx-4 {{ Request::is('dashboard/media*') ? 'active' : '' }}">
                                <svg class="nav-svg" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <title>OOH</title>
                                    <path
                    ...
                    <ul class="hidden" id="mediaChild" name="mediaChild">
                        @canany(['isAdmin', 'isMedia'])
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/videotrons">
                                    <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24">
                                        <path
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/signages">
                            ...
                            <li class="group">
                                <a class="nav-a ml-[40px]" href="/dashboard/media/product-categories">
                                    <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24">
                                        <path
                    ...
                    <li class="group">
                        <form action="/logout" method="post">
                            @csrf
                            <button type="submit" class="nav-a mx-4">
