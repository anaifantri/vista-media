<div class="div-nav-a">
    ...
    <li class="group hidden" id="liMarketing" name="liMarketing" onclick="showHideDropdown(this)">
        ...
        <ul class="hidden" id="marketingChild" name="marketingChild">
            ...
            <li id="quotReport" name="quotReport" class="group" onclick="childMenu(event,this)">
                <a class="nav-a ml-2 border-b-[1px]" href="#">
                    <svg class="child-nav-svg" role="img" clip-rule="evenodd" fill-rule="evenodd"
                        stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Sales Reports start -->
            <li id="saleReports" name="saleReports" class="group" onclick="childMenu(event,this)">
                <a class="nav-a ml-2 border-b-[1px]" href="#">
                    <svg class="child-nav-svg" role="img" clip-rule="evenodd" fill-rule="evenodd"
                        stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- SPK Reports start -->
            <li id="spkReports" name="spkReports" class="group" onclick="childMenu(event,this)">
                <a class="nav-a ml-2 border-b-[1px]" href="#">
                    <svg class="child-nav-svg" role="img" clip-rule="evenodd" fill-rule="evenodd"
                        stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
