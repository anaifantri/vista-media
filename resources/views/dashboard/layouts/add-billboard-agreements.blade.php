<!-- Add Agreement start -->
<form class="justify-center" action="/dashboard/marketing/client-agreements" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div>
            <div class="flex mt-10">
                <div class="flex w-[212px]">
                    <button id="btnAgreementSave" type="submit"
                        onclick="return confirm('Apakah anda yakin data sudah benar?')" hidden></button>
                    ...
                    <button id="btnAgreementClear" class="flex justify-center items-center mx-1 btn-danger mb-2"
                ...
                <div id="btnCloseAgreement" class="flex w-[588px] justify-end">
                    ...
                    <div>
                        <div class="flex justify-center w-full m-2">
                            ...
                            <input class="hidden" id="documentAgreement" name="document_agreement[]" type="file"
                                accept="image/png, image/jpg, image/jpeg" onchange="choseAgreementImage()" multiple>
                        </div>
