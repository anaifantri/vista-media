...
<div id="modalViewPO" name="modalViewPO"
    ...
    <div>
        <div class="flex mt-10">
            <div id="btnViewClosePO" class="hidden w-full justify-end">
                ...
                <div>
                    <div class="my-2 border-b-2 border-teal-700">
                        <div class="flex items-center mt-1">
                            ...
                            <label id="documentName" class="text-sm text-teal-700 ml-2"></label>
                        </div>
                        <div class="flex items-center mt-1">
                            <label class="text-sm text-teal-700 w-32">Nomor PO/SPK</label>
                            <label class="text-sm text-teal-700 ml-2">:</label>
                            <label id="orderViewNumber" class="text-sm text-teal-700 ml-2"></label>
                        </div>
                        <div class="flex items-center mt-1">
                            <label class="text-sm text-teal-700 w-32">Tanggal PO/SPK</label>
                            <label class="text-sm text-teal-700 ml-2">:</label>
                            <label id="orderViewDate" class="text-sm text-teal-700 ml-2"></label>
                        </div>
                        <div class="flex items-center mt-1">
