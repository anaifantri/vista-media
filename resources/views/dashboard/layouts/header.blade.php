<header class=" top-0 left-0 absolute w-full flex items-center z-50">
    <div class="w-full bg-cyan-800 z-40">
        <!-- Logo & Tittle Start-->
    ...
    <div class="w-full justify-end flex z-30 absolute items-center transition duration-500 ease-in-out origin-center -top-[145px]"
        id="profileChild" name="profileChild">
        <div class="flex absolute bg-emerald-50 w-32 h-32 top-[15px] rounded-b-xl border drop-shadow-md mr-6">
            <nav class="flex absolute top-[15px] w-36 mr-10">
                <ul class="ml-4 text-left">
                    <li class="group">
                        <a class="mt-2 nav-a" href="">
                            <svg class="fill-current" role="img" xmlns="http://www.w3.org/2000/svg" width="16"
                                viewBox="0 0 24 24">
