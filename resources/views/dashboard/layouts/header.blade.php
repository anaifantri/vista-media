<header class="">
    <div class="bg-cyan-800 top-0 left-0 absolute w-full flex items-center z-50">
        <div class="w-full">
            <!-- Logo & Tittle Start-->
    ...
    <div class="w-full justify-end flex z-40 absolute items-center transition duration-500 ease-in-out origin-center -top-[145px]"
