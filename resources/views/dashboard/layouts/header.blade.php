                ...
                <nav class="sm:flex w-full hidden">
                    ...
                    <ul
                        ...
                        <a class="right-nav text-white {{ Request::is('dashboard/media/billboards*') ? 'active' : '' }}"
                            ...
                            <span class="lg:flex hidden"> Billboard </span>
                        </a>
                    </ul>
                    <ul
                        ...
                        <a class="right-nav text-white {{ Request::is('dashboard/media/videotron*') ? 'active' : '' }}"
                            ...
                            <span class="lg:flex hidden"> Videotron </span>
                        </a>
                    </ul>
                    <ul class="flex group w-max lg:w-24 ml-4 h-6 hover:scale-110 transition duration-300 ease-in-out">
                        <a class="right-nav text-white {{ Request::is('dashboard/media/signages*') ? 'active' : '' }}"
                            ...
                            <span class="lg:flex hidden"> Signage </span>
                        </a>
                    </ul>
                    <ul id="setting" name="setting"
                        class="flex w-max lg:w-24 ml-4 h-6 hover:scale-110 transition duration-300 ease-in-out">
                        <div class="flex group">
                            <a class="right-nav text-white {{ Request::is('dashboard/media/area*') ? 'active' : '' }} {{ Request::is('dashboard/media/cities*') ? 'active' : '' }} {{ Request::is('dashboard/media/sizes*') ? 'active' : '' }} {{ Request::is('dashboard/users/users*') ? 'active' : '' }}"
                                href="#">
                                <svg class="fill-current w-5 mx-2" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path
                    ...
                    <div class="absolute items-center transition duration-500 ease-in-out mt-4 hidden sm:ml-[203px] md:ml-[250px] lg:ml-[458px]"
                        id="settingChild" name="settingChild">
                        <div class="flex absolute w-32 h-max top-6 bg-emerald-50 rounded-b-xl border drop-shadow-md">
                            <nav class="flex top-0 w-36 mr-10">
                                <ul class="ml-4 text-left">
                                    <li class="group">
                                        <a class="nav-a" href="/dashboard/media/area">
                                            <svg class="fill-current w-5 mr-2" xmlns="http://www.w3.org/2000/svg"
                                                role="img" viewBox="0 0 24 24">
                                                <path
                                    ...
                                    <li class="group">
                                        <a class="nav-a" href="/dashboard/users/users">
                                            <svg class="fill-current w-5 mr-2" role="img"
