        ...
        <div class="flex items-center relative justify-between">
                        ...
                        <nav>
                            <ul class="block">
                                <div>
                                    ...
                                    <li id="hamSetting" name="hamSetting" class="group">
                                        <a class="nav-a ml-4 border-t-[1px] border-b-[1px] {{ Request::is('dashboard/media/area*') ? 'active' : '' }} {{ Request::is('dashboard/media/cities*') ? 'active' : '' }} {{ Request::is('dashboard/users/users*') ? 'active' : '' }}"
                                            href="#">
            ...
            <div class="justify-start items-center px-2 w-full hidden sm:flex">
                <nav class="sm:flex w-full hidden">
                    ...
                    <div class="absolute items-center transition duration-500 ease-in-out mt-4 hidden sm:ml-[195px] lg:ml-[450px]"
