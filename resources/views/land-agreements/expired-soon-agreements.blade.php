    ...
    <div class="flex justify-center pl-14 py-10">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex p-1 w-full border-b">
                <!-- Title start -->
                <h1 class="index-h1">DAFTAR DATA SEWA LAHAN YANG AKAN SEGERA BERAKHIR</h1>
                <!-- Title end -->
            </div>
            <div>
                <!-- Form search start -->
                <form action="/media/expired-soon-agreements/">
        ...
        $(document).ready(function() {
            $('#btnExportExcel').on('click', function() {
                $('#exportExcelTable').table2excel({
                    filename: "List Sewa Lahan - Masa Sewa Segera Berakhir.xls"
                });
            });
        });
    </script>
