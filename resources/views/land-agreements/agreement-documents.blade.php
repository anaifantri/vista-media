<div class="w-[950px] p-4">
    <div class="border-t border-b p-1">
        <label class="flex justify-center text-sm font-semibold text-slate-500">DOKUMEN PERJANJIAN</label>
        <label class="flex justify-center text-sm font-semibold text-slate-500">Jumlah Dokumen :
            {{ count($agreements) }} dokumen</label>
    </div>
    <figure class="flex w-[950px] justify-center overflow-x-auto border-b-2 border-teal-700 mt-2" id="figureAgreement">
