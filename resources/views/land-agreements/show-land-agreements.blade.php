        ...
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex p-1 w-full border-b">
                ...
                <div class="flex w-full justify-end items-center">
                    <a class="flex justify-center items-center mx-1 btn-primary" href="/media/land-agreements">
                                ...
                                <td class="text-stone-900 border border-stone-900 text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaEdit')
                                                    <a href="/media/land-agreements/{{ $agreement->id }}/edit"
                                        ...
                                        @canany(['isAdmin', 'isMedia'])
                                            @can('isLegal')
                                                @can('isMediaDelete')
                                                    <form action="/media/land-agreements/{{ $agreement->id }}" method="post"
                                                        class="d-inline m-1">
                                                        @method('delete')
                                                        @csrf
                                                        <button
                                                            class="index-link text-white w-7 h-5 bg-red-500 rounded-md hover:bg-red-600"
                                                            onclick="return confirm('Apakah anda yakin ingin menghapus data sewa lahan dengan nomor {{ $agreement->number }} ?')">
