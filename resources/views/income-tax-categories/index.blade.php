        ...
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex justify-center w-full">
                <div class="w-[1200px]">
                                ...
                                @can('isPPh')
                                    @can('isAccountingCreate')
                                        <a href="/accounting/income-tax-categories/create" class="index-link btn-primary">
                                            ...
                                            <span class="mx-1">Tambah Objek PPh</span>
                                        </a>
                                    @endcan
                                @endcan
                            @endcanany
                    ...
                    <form id="formFilter" action="/accounting/income-tax-categories">
                        <div class="flex">
                            <div class="w-48 ml-2">
                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="bg-stone-400 h-8">
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-8">
                                    No.
                                </th>
                        ...
                        <tbody class="bg-stone-200">
                            ...
                            @foreach ($income_tax_categories as $income_tax_category)
                                ...
                                <tr>
                                    ...
                                    <td class="text-stone-900 border border-stone-900 text-sm px-2 text-center">
                                        {{ $income_tax_category->code }}
                                    </td>
                                    <td class="text-stone-900 px-2 border border-stone-900 text-sm">
                                        {{ $income_tax_category->name }}
                                    </td>
                                    <td class="text-stone-900 px-2 border border-stone-900 text-sm text-center">
                                        {{ $income_tax_category->rates }}
                                    </td>
                                    <td class="text-stone-900 px-2 border border-stone-900 text-sm text-center">
                                        <div class="flex justify-center items-center">
                                            <a href="/accounting/income-tax-categories/{{ $income_tax_category->id }}"
            ...
            <div class="flex justify-center text-stone-100 mt-2">
                {!! $income_tax_categories->appends(Request::query())->render('dashboard.layouts.pagination') !!}
            </div>
        </div>
    </div>
@endsection
