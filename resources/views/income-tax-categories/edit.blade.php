...
@section('container')
    <!-- Edit Objek Pajak start -->
    <!-- Form Edit Objek Pajak start -->
    <form action="/accounting/income-tax-categories/{{ $income_tax_category->id }}" method="post"
            ...
            <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
                <div class="flex justify-center w-full ">
                    <div class="flex w-[900px] border-b">
                        <!-- Title Area start -->
                        <h1 class="index-h1 w-[500px]"> EDIT OBJEK PPh</h1>
                        <!-- Title Area end -->
                ...
                <div class="flex justify-center mt-4">
                    <div class="w-full px-2">
                        <div class="flex mx-1 mt-3 items-center">
                            ...
                            <input name="code" class="input-area in-out-spin-none w-[200px]"
                                value="{{ $income_tax_category->code }}" placeholder="Input Kode Objek Pajak" autofocus
                                required>
                        </div>
                        @error('code')
                        ...
                        <div class="flex mx-1 mt-3 items-center">
                            ...
                            <textarea name="name" class="flex input-area w-[750px] @error('name') is-invalid @enderror" type="text"
                                placeholder="Input Nama Objek Pajak" rows="2" required>{{ $income_tax_category->name }}</textarea>
                        </div>
                        @error('name')
                            <div class="text-red-600 flex mx-1">
                                {{ $message }}
                        ...
                        <div class="flex mx-1 mt-3 items-center">
                            ...
                            <input name="rates" class="input-area w-[160px] in-out-spin-none" type="number"
                                placeholder="Input Tarif" value="{{ $income_tax_category->rates }}" required>
                        </div>
                        @error('rates')
                            <div class="text-red-600 flex mx-1">
                                {{ $message }}
    ...
    <!-- Form Edit Objek Pajak end -->
    <!-- Edit Objek Pajak end -->
@endsection
