            ...
            @foreach ($locations as $location)
                <tr>
                    ...
                    <td class="border text-center">
                        <div class="flex w-[64px] justify-center items-center">
                            <input id="billboardPriceMonth" name="{{ $location->code }}"
                    ...
                    <td class="border text-center">
                        <div class="flex w-[64px] justify-center items-center">
                            <input id="billboardPriceQuarter" name="{{ $location->code }}"
                                class="input-on-td in-out-spin-none w-[64px]" type="number" min="0"
                    ...
                    <td class="border text-center">
                        <div class="flex w-[64px] justify-center items-center">
                            <input id="billboardPriceHalf" name="{{ $location->code }}"
                                class="input-on-td in-out-spin-none w-[64px]" type="number" min="0"
                    ...
                    <td class="border text-center">
                        <div class="flex w-[72px] justify-center items-center">
                            <input id="billboardPriceYear" name="{{ $location->code }}"
