    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="p-4 w-[1000px] border rounded-lg bg-stone-700">
            <div class="flex p-1 w-full border-b">
                <!-- Title start -->
                <h1 class="index-h1 w-[400px]">DAFTAR PEMBAYARAN TAGIHAN LISTRIK</h1>
                <!-- Title end -->
                <!-- Button Back start -->
            ...
            <div class="grid grid-cols-2 mt-4">
                ...
                <div class="border rounded-lg p-2 bg-stone-200 ml-4">
                    ...
                    <form id="formFilter" action="/show-electricity-payment/{{ $electrical_power->id }}">
                        ...
                        <table class="table-auto w-[440px]">
                            <thead>
                                <tr class="bg-stone-400 h-8">
                                    ...
                                    <th class="text-stone-900 border border-stone-900 w-28 text-xs text-center">Tagihan
                                        Bulan
                                    </th>
                                    <th class="text-stone-900 border border-stone-900 w-28 text-xs text-center">Tgl.
                                        Pembayaran
                                    </th>
                                    <th class="text-stone-900 border border-stone-900 text-xs text-center w-32">Nominal</th>
                            ...
                            <tbody class="bg-stone-200">
                                ...
                                <tr>
                                    ...
                                    <td
                                        ...
                                        {{ number_format($payments->sum('payment')) }}
                                    </td>
