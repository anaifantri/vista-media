            ...
            <div class="flex justify-center w-full">
                <div class="w-[1000px]">
                    <div class="flex border-b">
                        <!-- Title start -->
                        <h1 class="index-h1"> DAFTAR KATAGORI KLIEN</h1>
                        <!-- Title end -->
                        <!-- Button Create start -->
                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="bg-stone-400 h-10">
                                ...
                                <th class="text-stone-900 border border-stone-900 text-sm text-center w-32">Action</th>
                            </tr>
                        </thead>
                        <tbody class="bg-stone-300">
                            @php
                                $number = 1 + ($client_categories->currentPage() - 1) * $client_categories->perPage();
                            @endphp
