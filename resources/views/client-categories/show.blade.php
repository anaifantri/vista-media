        ...
        <div class="p-4 w-[350px] h-[500px] border rounded-lg">
            ...
            <div>
                ...
                <div class="flex justify-center mt-2">
                    <a href="/client-categories" class="flex items-center justify-center btn-primary mx-1">
                    ...
                    <a href="/client-categories/{{ $client_category->id }}/edit"
                    ...
                    <form action="/client-categories/{{ $client_category->id }}" method="post" class="d-inline">
                        @method('delete')
                        @csrf
