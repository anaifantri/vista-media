        ...
        <table class="table-auto w-full">
            <thead>
                <tr class="bg-teal-100 h-5">
                    <th class="text-teal-700 border text-[0.65rem] w-8 text-center" rowspan="2">
                        No.
                    </th>
                    ...
                    <th class="text-teal-700 border text-[0.65rem] text-center" rowspan="2">
                        Lokasi</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center " colspan="5">
                        Jenis Reklame</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center " colspan="4">
                        Detail Kontrak</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center " colspan="2">
                        Periode Kontrak Aktif</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center " colspan="12">
                        Grafik Periode Kontrak</th>
                </tr>
                <tr class="bg-teal-100 h-5">
                    <th class="text-teal-700 border text-[0.65rem] text-center w-8">Jns</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-8">BL/FL</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-8">Side</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-8">Qty</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-20">Size</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-24">No.
                        Penjualan
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-28">Klien</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-20">Nilai</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-14">Durasi
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-16">Awal</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-16">Akhir</th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[31px]">Jan
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[28px]">Feb
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[31px]">Mar
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[30px]">Apr
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[31px]">Mei
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[30px]">Jun
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[31px]">Jul
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[31px]">Agu
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[30px]">Sep
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[31px]">Okt
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[30px]">Nop
                    </th>
                    <th class="text-teal-700 border text-[0.65rem] text-center w-[31px]">Des
                    </th>
                </tr>
            </thead>
            <tbody>
                @foreach ($locations as $location)
                    @if ($loop->iteration > $j * 35 && $loop->iteration <= $j * 35 + 35)
                        @php
                            $lastNumber = null;
                            $lastClient = null;
                            $lastPrice = null;
                            ...
                            if (count($location->sales) != 0) {
                                if ($location->sales[count($location->sales) - 1]->end_at > date('Y-m-d')) {
                                    ...
                                    $lastNumber = $location->sales[count($location->sales) - 1]->number;
                                    $lastPrice = $location->sales[count($location->sales) - 1]->price;
                        ...
                        <tr>
                            ...
                            <td class="relative text-teal-700 border text-[0.65rem] text-center">
                            </td>
                            <td class="relative text-teal-700 border text-[0.65rem] text-center">
                            </td>
                            <td class="relative text-teal-700 border text-[0.65rem] text-center">
