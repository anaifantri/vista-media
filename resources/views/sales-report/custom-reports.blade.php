    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="bg-stone-700 p-2 border rounded-md">
            <div class="flex justify-center m-2">
                <h1 class="text-xl text-stone-100 font-bold tracking-wider w-[1580px] border-b">DATA PENJUALAN MINGGUAN</h1>
            </div>
            @include('sales-report.custom-header')
            <div id="chartReport" class="flex justify-center z-0">
                ...
                <div id="pdfPreview">
                    ...
                    @else
                        @for ($i = 0; $i < $pageQty; $i++)
                            @if ($i == $pageQty - 1)
                                @include('sales-report.custom-last-page')
                            @else
                                @include('sales-report.custom-page')
                            @endif
                        @endfor
                    @endif
                </div>
