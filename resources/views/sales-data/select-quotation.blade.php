            ...
            <div class="flex w-[1200px] border-b">
                ...
                <div class="flex justify-end w-full">
                    ...
                    <a class="flex justify-center items-center ml-1 btn-danger"
                        href="/sales-data/home/{{ $data_category->name }}">
                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        @foreach ($quotations as $quotation)
                            ...
                            @endphp
                            @if ($status->status == 'Deal' && count($quotation->sales_data) == 0)
                                <tr>
    ...
    <script>
        ...
        salesCreate = () => {
            ...
            if (quotationId.value == "") {
                ...
                linkCreate.setAttribute('href', '/sales-data/create-sales/' + category.value +
                    '/' + quotationId.value);
                linkCreate.click();
            }
        }
