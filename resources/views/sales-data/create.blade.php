...
@section('container')
        ...
        <div class="flex w-full justify-center">
            <div class="flex w-[950px]">
                ...
                <a class="flex justify-center items-center ml-1 xl:mx-2 2xl:h-10 btn-danger"
                    href="/sales-data/select-quotation/{{ $category }}">
                                        ...
                                        <tbody id="tBodyCreate">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-xs text-teal-700 border text-right px-2">
                                                    <div class="flex justify-center items-center">
                                                        <input id="ppnYes" class="ml-2" type="radio"
                                                            name="radioPpn-{{ $loop->iteration - 1 }}" value="Yes"
                                                            checked onclick="ppnValueCheck(this)">
                                                        <label class="ml-1"> Ya </label>
                                                        <input id="{{ $loop->iteration - 1 }}" class="ml-2"
                                                            type="radio" name="radioPpn-{{ $loop->iteration - 1 }}"
                                                            value="No" onclick="ppnValueCheck(this)">
                                            ...
                                            <tr>
                                                <td class="border px-2 text-right text-xs text-teal-700 font-semibold"
                                                    ...
                                                    <div class="flex items-center justify-end">
                                                        ...
                                                        <input id="{{ $loop->iteration - 1 }}" class="ml-2"
                                                            type="radio" name="dpp-{{ $product->code }}"
                                                            value="Yes" checked onclick="radioCheck(this)">
                                                        <label class="ml-1"> Ya </label>
                                                        <input id="{{ $loop->iteration - 1 }}" class="ml-2"
                                                            type="radio" name="dpp-{{ $product->code }}"
                                                            value="No" onclick="radioCheck(this)">
                                                        <label class="ml-1"> Tidak </label>
                                                    </div>
                                                </td>
                                                <td class="text-xs text-teal-700 border text-right px-2">
                                                    <div>
                                                        <input id="dppValue" name="{{ $loop->iteration - 1 }}"
                                                            ...
                                                            type="number" min="0" value="{{ $getPrice }}"
                                                            readonly onkeyup="getDpp(this)">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                @elseif ($category == 'Signage')
                                                    @if ($description->type == 'Videotron')
                                                        <td class="border px-2 text-right text-xs text-teal-700 font-semibold"
                                                            colspan="4">{{ $thTitle }} (Harga + A - B)</td>
                                                    @else
                                                        <td class="border px-2 text-right text-xs text-teal-700 font-semibold"
                                                            colspan="4">TOTAL (Harga + A - B)</td>
                                                    @endif
    ...
    @include('sales-data.create-preview')
