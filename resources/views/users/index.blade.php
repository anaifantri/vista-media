                    ...
                    <tbody>
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="td-table-center">{{ $user->name }}</td>
                                <td class="td-table-center">{{ $user->username }}</td>
                                <td class="td-table-center">{{ $user->email }}</td>
                                <td class="td-table-center">{{ $user->phone }}</td>
                                <td class="td-table-center">{{ $user->division }}</td>
