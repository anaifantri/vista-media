    ...
    <div class="flex justify-center">
        <div class="mt-10">
            ...
            <div class="flex justify-center w-[1140px] mt-4">
                <div class="d-flex justify-center items-center w-96">
                    @if ($user->avatar)
                ...
                <div class="flex w-[280px]">
                    <div class="w-full">
                        ...
                        <div class="border-b mt-2">
                            <label class="text-sm text-teal-700">Username</label>
                        ...
                        <div class="border-b mt-2">
                            <label class="text-sm text-teal-700">Jenis Kelamin</label>
                            @if ($user->gender == 'Male')
                                <h6 class="text-base font-semibold text-teal-900">Laki-Laki</h6>
                            @elseif ($user->gender == 'Female')
                                <h6 class="text-base font-semibold text-teal-900">Perempuan</h6>
                            @endif
                        </div>
                    </div>
                </div>
                <div class="flex w-[280px] ml-4">
                    <div class="w-full">
                        <div class="border-b mt-2">
                            <label class="text-sm text-teal-700">Divisi</label>
                            <h6 class="text-base font-semibold text-teal-900">{{ $user->division }}</h6>
                        </div>
                        <div class="border-b mt-2">
                        ...
                        <div class="border-b mt-2">
                            <label class="text-sm text-teal-700">Level Akses</label>
                            <h6 class="text-base font-semibold text-teal-900">{{ $user->level }}</h6>
                        </div>
                        <div class="border-b mt-2">
                            <label class="text-sm text-teal-700">Tanggal Terdaftar</label>
                            <h6 class="text-base font-semibold text-teal-900">{{ $user->created_at->format('l, d-M-Y') }}
                            </h6>
                        </div>
                        <div class="border-b mt-2">
                            <label class="text-sm text-teal-700">Tanggal Perubahan Terakhir</label>
