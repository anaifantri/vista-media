...
<div class="w-[{{ $width }}px]">
    ...
    @else
        <div id="divInclude" class="hidden justify-center mt-2">
            <div class="flex w-[725px]">
                @if ($notes->includedInstall->checked == true)
                    <input id="cbIncludeInstall" class="text-xs" type="checkbox" onclick="cbIncludeInstallAction(this)"
                        checked>
            ...
            @if (count($products) == 1)
                ...
                @if ($notes->includedPrint->checked == true)
                    <tr id="rowPrint">
                        ...
                        <td class="text-[0.7rem] text-black border border-black px-2" colspan="{{ $colSpan + 5 }}">
                            <div class="flex">
                                ...
                                <input id="printPrice"
                                    ...
                                    value="{{ $notes->includedPrint->price }}" onkeyup="inputPrintPriceCheck(this)"
                                    readonly>
                                ...
                                @else
                                    @php
                                        $wide = (int) $product->width * (int) $product->height * (int) $product->side;
                                    @endphp
                                    <input id="printWide"
                                        class="ml-1 w-8 outline-none border rounded-md px-1 in-out-spin-none text-center"
                                        type="number" min="1" value="{{ $wide }}" readonly>
                ...
                @if ($notes->includedInstall->checked == true)
                    <tr id="rowInstall" hidden>
                        ...
                        <td class="text-[0.7rem] text-black border border-black px-2" colspan="{{ $colSpan + 5 }}">
                            <div class="flex">
                                ...
                                <input id="installPrice"
                                    ...
                                    onkeyup="inputInstallPriceCheck(this)" onchange="inputInstallPriceChange(this)">
                        ...
                        <td id="totalInstall" class="text-[0.7rem] text-black border border-black text-right px-2">
                            @php
                ...
                <tr id="rowPrint" hidden>
                    ...
                    <td class="text-[0.7rem] text-black border border-black px-2" colspan="{{ $colSpan + 5 }}">
                        <div class="flex">
                            ...
                            <span class="ml-2 w-[72px]">-> Harga/m2</span>
                            <span>:</span>
                            <input id="printPrice" class="ml-1 w-12 outline-none border rounded-md px-1 text-right"
                                type="text" placeholder="0" onchange="inputPrintPriceChange(this)"
                                onkeyup="inputPrintPriceCheck(this)" readonly>
                            <span class="ml-2">-> Jumlah : </span>
                            <input id="includePrintQty"
                                class="ml-1 w-6 outline-none border rounded-md px-1 in-out-spin-none text-center"
                                type="number" min="1" value="1" onchange="inputPrintQtyChange(this)"
                                onkeyup="inputPrintQtyCheck(this)">
                            <span class="ml-2">-> Luas media : </span>
                            @if ($product->category == 'Signage')
                                <input id="printWide"
                                    class="ml-1 w-8 outline-none border rounded-md px-1 in-out-spin-none text-center"
                ...
                <tr id="rowInstall" hidden>
                    ...
                    <td class="text-[0.7rem] text-black border border-black px-2" colspan="{{ $colSpan + 5 }}">
                        <div class="flex">
                            ...
                            <input id="includeInstallQty"
                                class="ml-1 w-6 outline-none border rounded-md px-1 in-out-spin-none text-center"
                                type="number" min="1" value="1" onkeyup="inputInstallQtyCheck(this)"
                                onchange="inputInstallQtyChange(this)">
                            <span class="ml-2">-> Luas media : </span>
                            @if ($product->category == 'Signage')
                                <input id="installWide"
                                    class="ml-1 w-8 outline-none border rounded-md px-1 in-out-spin-none text-center"
