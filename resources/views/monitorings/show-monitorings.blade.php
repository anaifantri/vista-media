        ...
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex p-1 w-full border-b">
                ...
                <div class="flex w-full justify-end items-center">
                    <a class="flex justify-center items-center mx-1 btn-primary" href="/workshop/monitorings">
                                                ...
                                                @can('isWorkshopDelete')
                                                    <form action="/workshop/monitorings/{{ $monitoring->id }}" method="post"
                                                        ...
                                                        <button
                                                            ...
                                                            onclick="return confirm('Apakah anda yakin ingin menghapus data pemantauan bulanan..?')">
