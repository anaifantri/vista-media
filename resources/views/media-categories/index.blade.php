    ...
    <div class="mt-10 z-0">
        <div class="flex justify-center w-full">
            <div class="w-[800px] p-2">
                ...
                <form class="mt-2" action="/media-categories/">
                    <div class="flex">
                            ...
                            <tr>
                                ...
                                <td class="text-teal-700 border text-xs text-center">
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="/media-categories/{{ $category->id }}/edit"
                                        ...
                                        @can('isAdmin')
                                            <form action="/media-categories/{{ $category->id }}" method="post"
                                                class="d-inline m-1">
                                                @method('delete')
                                                @csrf
                                                <button
                                                    class="index-link text-white w-7 h-5 bg-red-500 rounded-md hover:bg-red-600"
                                                    onclick="return confirm('Apakah anda yakin ingin menghapus data katagori media dengan nama {{ $category->name }} ?')">
