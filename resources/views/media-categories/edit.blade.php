...
@section('container')
    <div class="flex justify-center mt-10">
        <form class="md:flex" method="post" action="/media-categories/{{ $media_category->id }}" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="flex w-[300px] justify-center items-center">
                <div class="p-3 w-full">
                    <div class="flex items-center justify-center mb-2 border-b w-full">
                        <h4 class="text-xl font-semibold tracking-wider text-teal-900">Edit Katagori Media</h4>
                    </div>
                    <div class="flex justify-center mt-5 w-full">
                        <div>
                            ...
                            <div class="mt-1">
                                ...
                                <textarea
                                    class="flex text-semibold w-[250px]  border rounded-lg p-1 outline-teal-300 @error('description') is-invalid @enderror"
