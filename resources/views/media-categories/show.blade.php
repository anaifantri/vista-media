            ...
            <div class="flex justify-center w-[350px] items-center">
                <div class="p-3 w-full">
                    <div class="flex items-center mb-3 w-full border-b">
                        <h4 class="text-xl font-semibold tracking-wider text-teal-900">Detail Katagori Billboard</h4>
                    </div>
                    <div class="flex justify-center mt-3 w-full">
                        <div>
                            ...
                            <div class="mt-1">
                                ...
                                <textarea class="flex text-semibold w-[300px]  border rounded-lg p-1 outline-teal-300" readonly>{{ $media_category->description }}</textarea>
                            </div>
                            <div class="border-b mt-2">
                            ...
                            <div class="flex mt-2">
                                ...
                                <form action="/media-categories/{{ $media_category->id }}" method="post" class="d-inline">
                                    ...
                                    <button class="flex items-center justify-center btn-danger mx-1"
                                        onclick="return confirm('Apakah anda yakin ingin menghapus katagori billboard dengan nama {{ $media_category->name }} ?')">
                                        <svg class="fill-current w-5" clip-rule="evenodd" fill-rule="evenodd"
                                            stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
