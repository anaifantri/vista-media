    ...
    <div class="flex justify-center pl-14 py-10 bg-stone-800">
        <div class="z-0 mb-8 bg-stone-700 p-2 border rounded-md">
            <div class="flex justify-center w-full">
                <div class="w-[1200px]">
                    <div class="flex border-b">
                        <h1 class="index-h1">DAFTAR SURAT PENGANTAR TAGIHAN</h1>
                        <div class="flex">
                        ...
                        <thead>
                            <tr class="bg-stone-400">
                                ...
                                <th class="text-stone-900 border border-stone-900 text-xs text-center w-32">
                                    <button class="flex justify-center items-center w-full">@sortablelink('number', 'No. Surat')
                        ...
                        <tbody class="bg-stone-200">
                            @foreach ($bill_cover_letters as $bill_cover_letter)
                                ...
                                <tr>
                                    ...
                                    <td class="text-stone-900 px-1 border border-stone-900 text-xs text-center">
                                        {{ substr($bill_cover_letter->number, 0, 15) }}..
                                    </td>
                                    <td class="text-stone-900 px-1 border border-stone-900 text-xs text-center">
                                    ...
                                    <td class="text-stone-900 px-1 border border-stone-900 text-xs text-center">
                                        <div class="flex justify-center items-center">
                                            ...
                                            @canany(['isAdmin', 'isAccounting'])
                                                @can('isCollect')
                                                    @can('isAccountingEdit')
                                                        <a href="/accounting/bill-cover-letters/{{ $bill_cover_letter->id }}/edit"
                                            ...
                                            @endcanany
                                            @can('isAdmin')
                                                <form action="/accounting/bill-cover-letters/{{ $bill_cover_letter->id }}"
                                                    method="post" class="d-inline m-1">
                                                    @method('delete')
                                                    @csrf
                                                    <button
                                                        class="index-link text-white w-7 h-5 bg-red-500 rounded-md hover:bg-red-600"
                                                        onclick="return confirm('Apakah anda yakin ingin menghapus data surat pengantar dengan nomor {{ $bill_cover_letter->number }} ?')">
            ...
            <div class="flex justify-center text-stone-100 mt-2">
                {!! $bill_cover_letters->appends(Request::query())->render('dashboard.layouts.pagination') !!}
            </div>
        </div>
    </div>
